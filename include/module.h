...
int BX_add_module_proc(unsigned int, char *, char *, char *, int, int, void *,
                       void *);
...
union BXGlobalEntry {
  ...
  char *(*malloc_strcpy_slot)(char **, const char *, const char *, const char *,
                              int);
  char *(*malloc_strcat_slot)(char **, const char *, const char *, const char *,
                              int);
  ...
  int (*figure_out_address_slot)(char *, char **, char **, char **, char **,
                                 int *);
  ...
  char *(*m_strcat_ues_slot)(char **, char *, int, const char *, const char *,
                             const int);
  char *(*m_strndup_slot)(const char *, size_t, const char *, const char *,
                          const int);
  ...
  List *(*list_lookup_ext_slot)(List **, char *, int, int,
                                int (*)(List *, char *));
  ...
  void *(*find_fixed_array_item_slot)(void *, size_t, int, const char *, int *,
                                      int *);
  ...
  void (*add_wait_prompt_slot)(char *, void (*)(char *, char *), char *, int,
                               int);
  ...
  ChannelList *(*add_to_channel_slot)(char *, char *, int, int, int, char *,
                                      char *, char *, int, int);
  ...
  NickList *(*find_nicklist_in_channellist_slot)(const char *, ChannelList *,
                                                 int);
  ...
  List *(*find_name_in_genericlist_slot)(const char *, HashEntry *,
                                         unsigned int, int);
  void (*add_whowas_userhost_channel_slot)(WhowasList *, WhowasWrapList *);
  WhowasList *(*find_userhost_channel_slot)(char *, char *, int,
                                            WhowasWrapList *);
  ...
  Flooding *(*add_name_to_floodlist_slot)(char *, char *, char *, HashEntry *,
                                          unsigned int);
  Flooding *(*find_name_in_floodlist_slot)(char *, char *, HashEntry *,
                                           unsigned int, int);
  ...
  int (*add_module_proc_slot)(unsigned int, char *, char *, char *, int, int,
                              void *, void *);
  int (*remove_module_proc_slot)(unsigned int, char *, char *, char *);
  char *(*add_timer_slot)(int, char *, double, long, int (*)(void *, char *),
                          char *, char *, int, char *);
  ...
  void (*add_to_server_list_slot)(char *, int, char *, char *, char *, int,
                                  int);
  ...
  int (*add_socketread_slot)(int, int, unsigned long, char *, void (*)(int),
                             void (*)(int));
  ...
  char *(*alias_special_char_slot)(char **, char *, const char *, char *,
                                   int *);
  ...
  DCC_int *(*dcc_create_func_slot)(char *, char *, char *, unsigned long, int,
                                   int, unsigned long, void (*)(int));
  SocketList *(*find_dcc_func_slot)(const char *, const char *, const char *,
                                    int, int, int, int);
  ...
  void (*userhostbase_slot)(char *, void (*)(UserhostItem *, char *, char *),
                            int, char *, ...);
  void (*isonbase_slot)(char *, void (*)(char *, char *));
  void (*whobase_slot)(char *, void (*)(WhoEntry *, char *, char **),
                       void (*)(WhoEntry *, char *, char **), char *, ...);
