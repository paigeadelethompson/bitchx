...
#define LOG_ALL                                                                \
  (LOG_CRAP | LOG_PUBLIC | LOG_MSG | LOG_NOTICE | LOG_WALL | LOG_WALLOP |      \
   LOG_NOTES | LOG_OPNOTE | LOG_SNOTE | LOG_ACTION | LOG_CTCP | LOG_DCC |      \
   LOG_USER1 | LOG_USER2 | LOG_USER3 | LOG_USER4 | LOG_USER5 | LOG_BEEP |      \
   LOG_TCL | LOG_SEND_MSG | LOG_MODE_USER | LOG_MODE_CHAN | LOG_KICK_USER |    \
   LOG_KICK | LOG_PART | LOG_INVITE | LOG_JOIN | LOG_TOPIC | LOG_HELP |        \
   LOG_KILL | LOG_NOTIFY)
