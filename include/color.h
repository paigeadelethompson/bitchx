...
#define DEFAULT_FORMAT_ACTION_OTHER_FSET                                       \
  ansi ? "%@%K≡ %c$3%K>%W$1 %n$4-" : "%@≡ $3>$1 $4-"
#define DEFAULT_FORMAT_ACTION_OTHER_AR_FSET                                    \
  ansi ? "%@%K≡ %c$3%K>%Y$1 %n$4-" : "%@≡ $3>$1 $4-"
...
#define DEFAULT_STATUS_FORMAT                                                  \
  "[1;30;40m┌[0;37m%T %*[1;36m%N[0;37m%# %@%C%+ %A%W%H%B%M%Q %>%D %L "     \
  "[1;30m]"
#define DEFAULT_STATUS_FORMAT1                                                 \
  "[1;30;40m┌─ [1;37mU[0;37mser[1;30m: %*[1;36m%N[0;37m%#%A %^%H%B "     \
  "%>%D %S [1;30m─┐"
...
#define DEFAULT_STATUS_WINDOW "[1;30;40m[[1;37m■[1;30m][0;37m"
...
#define DEFAULT_INPUT_PROMPT                                                   \
  "[1;30;40m└-[[1;37mb[0;37mitch[0;36mx[1;30m]─>[0;37m "

#ifndef ONLY_STD_CHARS
#define DEFAULT_SHOW_NUMERICS_STR "[1;30m∙[0m[1;36mφ[1;30m∙[0m"
#else
#ifndef LATIN1
...
#ifndef ONLY_STD_CHARS
#define DEFAULT_SHOW_NUMERICS_STR "[1;31m∙[0m[1;37mφ[1;31m∙[0m"
#else
#ifndef LATIN1
#define DEFAULT_SHOW_NUMERICS_STR "***"
#else
