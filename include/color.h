...
#define DEFAULT_FORMAT_471_FSET                                                \
  "$G $1 :Sorry, cannot join channel. %K(%WChannel is full%K)%n"
#define DEFAULT_FORMAT_473_FSET                                                \
  "$G $1 :Sorry, cannot join channel. %K(%WInvite only channel%K)%n"
#define DEFAULT_FORMAT_474_FSET                                                \
  "$G $1 :Sorry, cannot join channel. %K(%WBanned from channel%K)%n"
#define DEFAULT_FORMAT_475_FSET                                                \
  "$G $1 :Sorry, cannot join channel. %K(%WBad channel key%K)%n"
...
#define DEFAULT_FORMAT_ACTION_AR_FSET                                          \
  ansi ? "%@%Kð %Y$1 %n$4-" : "%@ð $1 $4-"
#define DEFAULT_FORMAT_ACTION_CHANNEL_FSET                                     \
  ansi ? "%@%Kð %W$1 %n$4-" : "%@ð $1 $4-"
#define DEFAULT_FORMAT_ACTION_OTHER_FSET                                       \
  ansi ? "%@%Kð %c$3%K>%W$1 %n$4-" : "%@ð $3>$1 $4-"
#define DEFAULT_FORMAT_ACTION_OTHER_AR_FSET                                    \
  ansi ? "%@%Kð %c$3%K>%Y$1 %n$4-" : "%@ð $3>$1 $4-"
#define DEFAULT_FORMAT_ACTION_USER_FSET                                        \
  ansi ? "%@%Kð %c$3%K>%W$1 %n$4-" : "%@ð $3>$1 $4-"
#define DEFAULT_FORMAT_ACTION_USER_AR_FSET                                     \
  ansi ? "%@%Kð %c$3%K>%Y$1 %n$4-" : "%@ð $3>$1 $4-"
...
#define DEFAULT_FORMAT_BACK_FSET                                               \
  "is back from the dead. Gone $1 hrs $2 min $3 secs"

/* Done BANS */
#define DEFAULT_FORMAT_BANS_HEADER_FSET "#  Channel    SetBy        Sec  Ban"
#define DEFAULT_FORMAT_BANS_FSET                                               \
  "%W$[-2]0%K:%n $[26]2 %K(%c$[20]3%K:%c$[24]4-%K)"
#define DEFAULT_FORMAT_BANS_FOOTER_FSET                                        \
  "%K[ %nEnd of channel %W$0 %K- %W$1 %nbans counted %K]"

#define DEFAULT_FORMAT_EBANS_HEADER_FSET                                       \
  "#  Channel    SetBy        Sec  ExemptBan"
#define DEFAULT_FORMAT_EBANS_FSET                                              \
  "%W$[-2]0%K:%n $[26]2 %K(%c$[20]3%K:%c$[24]4-%K)"
#define DEFAULT_FORMAT_EBANS_FOOTER_FSET                                       \
  "%K[ %nEnd of channel %W$0 %K- %W$1 %nexemptbans counted %K]"

#define DEFAULT_FORMAT_BITCH_FSET "%RBitch Mode Activated%n $1 $4 $5 on $3"
#define DEFAULT_FORMAT_BOT_HEADER_FSET                                         \
  "Aop Prot Bot         Channel    Hostname"
...
/* Done CTCP */
#define DEFAULT_FORMAT_CTCP_FSET                                               \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested $4 from $3"
#define DEFAULT_FORMAT_CTCP_CLOAK_FSET                                         \
  "%K>%n>%W> %C$1 %K[%c$2%K]%c requested $4 from $3"
#define DEFAULT_FORMAT_CTCP_CLOAK_FUNC_FSET                                    \
  "%K>%n>%W> %C$1 %K[%c$2%K]%c requested $4 from $3"
#define DEFAULT_FORMAT_CTCP_CLOAK_FUNC_USER_FSET                               \
  " %K>%n>%W> %C$1 %K[%c$2%K]%c requested $4 from you"
#define DEFAULT_FORMAT_CTCP_CLOAK_UNKNOWN_FSET                                 \
  "%K>%n>%W> %C$1 %K[%c$2%K]%c requested unknown ctcp $4 from $3"
#define DEFAULT_FORMAT_CTCP_CLOAK_UNKNOWN_USER_FSET                            \
  "%K>%n>%W> %C$1 %K[%c$2%K]%c requested unknown ctcp $4 from you"
#define DEFAULT_FORMAT_CTCP_CLOAK_USER_FSET                                    \
  "%K>%n>%W> %C$1 %K[%c$2%K]%c requested $4 from you"
#define DEFAULT_FORMAT_CTCP_FUNC_FSET                                          \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested $4 from $3"
#define DEFAULT_FORMAT_CTCP_FUNC_USER_FSET                                     \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested $4 from you"
#define DEFAULT_FORMAT_CTCP_UNKNOWN_FSET                                       \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested unknown ctcp $4 from $3"
#define DEFAULT_FORMAT_CTCP_UNKNOWN_USER_FSET                                  \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested unknown ctcp $4 from you"
#define DEFAULT_FORMAT_CTCP_USER_FSET                                          \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested $4 from you"
...
#define DEFAULT_FORMAT_DCC_CONNECT_FSET                                        \
  "$G DCC $1 %nconnection with %W$2%K[%c$4 $5%K]%n established"
#define DEFAULT_FORMAT_DCC_ERROR_FSET "$G %rDCC lost %w$1%w %rto $2 %K[%w$3-%K]"
#define DEFAULT_FORMAT_DCC_LOST_FSET                                           \
  "$G %nDCC %W$1%n:%g$2%n %K[%C$3%K]%n $4 $5 completed in $6 secs %K(%W$7 "    \
  "kb/sec%K)"
#define DEFAULT_FORMAT_DCC_REQUEST_FSET                                        \
  "$G DCC $1 %K(%n$2 $3%K)%n request from %W$4%K[%c$5:$6%K]"

#define DEFAULT_FORMAT_DESYNC_FSET "$G $1 is desynced from $2 at $0"
#define DEFAULT_FORMAT_DISCONNECT_FSET                                         \
  "$G Use %G/Server%n to connect to a server"
...
#define DEFAULT_FORMAT_FLOOD_FSET                                              \
  "%Y$1%n flood detected from %G$2%K(%g$3%K)%n on %K[%G$4%K]"
...
#define DEFAULT_FORMAT_KICK_USER_FSET                                          \
  "$G %WYou%n have been kicked off $2 by %c$1 %K(%n$4-%K)"
#define DEFAULT_FORMAT_KILL_FSET "$G %WYou%n have been killed by $1 for $2-"

/* Done LINKS */
#define DEFAULT_FORMAT_LINKS_FSET                                              \
  "$G %K[%c$[-3]0%K] [%c$[-3]3%K] [%n$[-27]1%K]%n <- %K[%n$[-27]2%K]"
#define DEFAULT_FORMAT_LINKS_HEADER_FSET                                       \
  "$G %K[%cNum%K] [%cHop%K]                      [%cServer%K]                " \
  "         [%cUplink%K]"
...
#define DEFAULT_FORMAT_MODE_CHANNEL_FSET                                       \
  "$G %nmode%K/%c$3 %K[%W$4-%K]%n by %W$1"
...
#define DEFAULT_FORMAT_IGNORE_INVITE_FSET                                      \
  "%K>%n>%W> You have been invited to $1-"
...
#define DEFAULT_FORMAT_NAMES_NONOP_FSET                                        \
  "$G %K[%cNonChanOps%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
#define DEFAULT_FORMAT_NAMES_OP_FSET                                           \
  "$G %K[%cChanOps%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
#define DEFAULT_FORMAT_NAMES_PROMPT_FSET "$G $0-"
#define DEFAULT_FORMAT_NAMES_VOICE_FSET                                        \
  "$G %K[%cVoiceUsers%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
...
/* In bx but not hades*/
#define DEFAULT_FORMAT_NAMES_BOT_FSET                                          \
  "$G %K[%cBots%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
#define DEFAULT_FORMAT_NAMES_FRIEND_FSET                                       \
  "$G %K[%cFriends%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
#define DEFAULT_FORMAT_NAMES_IRCOP_FSET                                        \
  "$G %K[%cIrcOps%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"
#define DEFAULT_FORMAT_NAMES_SHIT_FSET                                         \
  "$G %K[%cShitUsers%K(%W$1%K:%W$2%K/%W$3%K)]%c $4"

#define DEFAULT_FORMAT_NETADD_FSET "$G %nAdded: %W$1 $2"
#define DEFAULT_FORMAT_NETSPLIT_FSET                                           \
  "$G %nNetsplit detected%K: %W$1%n split from %W$2 %K[%c$0%K]"
...
#define DEFAULT_FORMAT_NICKNAME_USER_FSET                                      \
  "$G %WYou%K(%n$1%K)%n are now known as %c$3"
...
#define DEFAULT_FORMAT_NOTIFY_SIGNOFF_FSET                                     \
  "$G %GSignoff%n by %r$1%K!%r$2%n at $0"
...
/* Not in Hades*/
#define DEFAULT_FORMAT_SEND_AWAY_FSET                                          \
  "[Away ($strftime($1 %a %b %d %I:%M%p %Z))] [$tdiff2(${time() - u})] "       \
  "[BX-MsgLog $2]"
...
#define DEFAULT_FORMAT_SEND_ENCRYPTED_PUBLIC_FSET "%y<%n$2%K:%n$1%y>%n $3-"
...
#define DEFAULT_FORMAT_SERVER_NOTICE_BOT1_FSET                                 \
  "Possible $1 bot: %C$2 %K[%c$3-%K]%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_BOT_ALARM_FSET                            \
  "$1 alarm activated: %C$2 %K[%c$3-%K]%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_CONNECT_FSET                       \
  "Client Connecting: %C$1 %K[%c$2%K]%n $3-"
#define DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_EXIT_FSET                          \
  "Client Exiting: %C$1 %K[%c$2%K]%n $3-"
#define DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_INVALID_FSET                       \
  "Invalid username: %C$1 %K[%c$2-%K]%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_TERM_FSET                          \
  "Terminating client for excess flood %C$1%K [%c$2-%K]%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_FAKE_FSET "Fake Mode detected on $1 -> $2-"
#define DEFAULT_FORMAT_SERVER_NOTICE_KILL_FSET                                 \
  "Foreign OperKill: %W$1%n killed %c$2%n %K(%n$3-%K)%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_KILL_LOCAL_FSET                           \
  "Local OperKill: %W$1%n killed %c$2%n %K(%n$3-%K)%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_KLINE_FSET                                \
  "%W$1%n added a new $3 %K[%c$2%K]%n for %K[%R$4-%K]"
#define DEFAULT_FORMAT_SERVER_NOTICE_GLINE_FSET                                \
  "%W$1%n added a new $4 %K[%c$2%K]%n from %W$3%n for %K[%R$4-%K]"
#define DEFAULT_FORMAT_SERVER_NOTICE_NICK_COLLISION_FSET                       \
  "Nick collision %W$1%n killed %c$2-%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_OPER_FSET                                 \
  "%C$1 %K[%c$2%K]%n is now %Wan%w %GIRC%n whore"
#define DEFAULT_FORMAT_SERVER_NOTICE_REHASH_FSET                               \
  "%W$1%n is rehashing the Server config file"
#define DEFAULT_FORMAT_SERVER_NOTICE_STATS_FSET "Stats $1: %C$2 %K[%c$3-%K]%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_TRAFFIC_HIGH_FSET                         \
  "Entering high-traffic mode %K(%n$1 > $2-%K)%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_TRAFFIC_NORM_FSET                         \
  "Resuming standard operation %K(%n$1 $2 $3-%K)%n"
#define DEFAULT_FORMAT_SERVER_NOTICE_UNAUTH_FSET                               \
  "Unauthorized Connection from $1-"
...
#define DEFAULT_FORMAT_SHITLIST_HEADER_FSET                                    \
  " lvl nick!user@host                     channels   reason"
...
#define DEFAULT_FORMAT_TOPIC_CHANGE_FSET                                       \
  "$G %W$1 %nhas changed the topic on channel %W$2%n to%K:%n $3-"
#define DEFAULT_FORMAT_TOPIC_SETBY_FSET                                        \
  "$G %nTopic set by %c$2%K [%c$stime($3) ago%K]"
#define DEFAULT_FORMAT_TOPIC_UNSET_FSET "$G %nTopic unset by $1 on $2"

#define DEFAULT_FORMAT_USAGE_FSET "$G Usage: /$0  $1-"
#define DEFAULT_FORMAT_USERMODE_FSET                                           \
  "$G %nMode change %K[%W$4-%K]%n for user %c$3"
#define DEFAULT_FORMAT_USERMODE_OTHER_FSET                                     \
  "$G %nMode change %K[%W$4-%K]%n for user %c$3%n by %W$1"
...
#define DEFAULT_FORMAT_USERLIST_HEADER_FSET                                    \
  "level            nick       password     host                      "        \
  "channels"

#define DEFAULT_FORMAT_USERS_HEADER_FSET                                       \
  "%K[ %WC%nhannel   %K] [ %WN%wickname  %K] [ %WU%wser@host                 " \
  "           %K] [ %WL%wevel %K]"
#define DEFAULT_FORMAT_USERS_FSET                                              \
  "%K[%n$[11]1%K] [%C$5%c$[10]2%K] [%n$[38]3%K][%n$[7]0%K]"
#define DEFAULT_FORMAT_USERS_USER_FSET                                         \
  "%K[%n$[11]1%K] [%C$5%c$[10]2%K] [%p$[38]3%K][%n$[7]0%K]"
#define DEFAULT_FORMAT_USERS_SHIT_FSET                                         \
  "%K[%n$[11]1%K] [%C$5%c$[10]2%K] [%r$[38]3%K][%n$[7]0%K]"
#define DEFAULT_FORMAT_USERS_TITLE_FSET NULL

/* #define DEFAULT_FORMAT_USERS_FOOTER_FSET "%K[ %nEnd of channel %W$0 %K- %W$1
 * %nusers counted %K]"*/
/* #define DEFAULT_FORMAT_USERS_NONE_FSET "$G No match of %W$0%n on %c$1"*/

#define DEFAULT_FORMAT_VERSION_FSET                                            \
  "\002$0+$4$5\002 by panasync \002-\002 $2 $3"
...
#define DEFAULT_FORMAT_WHOIS_HEADER_FSET                                       \
  "%GÚÄÄÄÄÄÄÄÄ%gÄ%GÄÄ%gÄÄ%GÄ%gÄÄÄÄÄÄÄÄÄ%KÄ%gÄÄ%KÄÄ%gÄ%KÄÄÄÄÄÄÄÄÄÄ-Ä ÄÄ  Ä   -"
#define DEFAULT_FORMAT_WHOIS_IDLE_FSET                                         \
  "%K. %Wi%ndle     %K:%n $0 hours $1 mins $2 secs (signon: $stime($3))"
...
#define DEFAULT_FORMAT_WHOLEFT_HEADER_FSET                                     \
  "%PÚÄÄÄÄÄ %WWho %PÄÄÄÄÄ%pÄÄÄ%PÄÄÄ%pÄÄ%PÄÄÄÄÄ%pÄÄ%PÄÄ %WChannel%p Ä%KÄ "      \
  "%WServer %KÄ%pÄÄÄÄ%KÄÄ%pÄÄ%KÄÄ-- %WSeconds"
#define DEFAULT_FORMAT_WHOLEFT_USER_FSET "%P³%n $[-10]0!$[20]1 $[10]2 $[20]4 $3"
#define DEFAULT_FORMAT_WHOLEFT_FOOTER_FSET                                     \
  "%PÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ%pÄÄ%PÄÄÄ%pÄÄÄ%PÄÄ%pÄ%PÄ%pÄÄÄÄÄ%KÄ%pÄÄÄ%KÄÄÄ%pÄÄ%KÄÄÄÄÄÄ" \
  "ÄÄÄÄÄÄÄÄÄ-- --  -"
...
#define DEFAULT_FORMAT_COMPLETE_FSET                                           \
  "%K[%n$[15]0%K] [%n$[15]1%K] [%n$[15]2%K] [%n$[15]3%K]"
...
#define DEFAULT_STATUS_FORMAT                                                  \
  "[1;30;40mÚ[0;37m%T %*[1;36m%N[0;37m%# %@%C%+ %A%W%H%B%M%Q %>%D %L "     \
  "[1;30m]"
#define DEFAULT_STATUS_FORMAT1                                                 \
  "[1;30;40mÚÄ [1;37mU[0;37mser[1;30m: %*[1;36m%N[0;37m%#%A %^%H%B "     \
  "%>%D %S [1;30mÄ¿"
#define DEFAULT_STATUS_FORMAT2                                                 \
  "[1;30;40m³  [1;37mC[0;37mhannel[1;30m:[0;37m %@%C%+%W %M%Q %>%T %L "   \
  "[1;30mÄÙ"
...
#define DEFAULT_STATUS_OPER_KILLS                                              \
  "[1;30;40m[[1;37mnk [1;36m%d[1;30m:[1;37mok [1;36m%d[1;30m][0;37m"
...
#define DEFAULT_STATUS_MSGCOUNT                                                \
  " [1;37mM[0;37msgs[1;30m: ([1;36m%^[1;30m)[0;37m"
...
#define DEFAULT_STATUS_USERS                                                   \
  "[0;44m[[37mO[36m/[1;37m%! [0;44mN[36m/[1;37m%! "                     \
  "[0;44mI[36m/[1;37m%! [0;44mV[36m/[1;37m%! "                           \
  "[0;44mF[36m/[1;37m%![0;44m]"
...
#define DEFAULT_INPUT_PROMPT                                                   \
  "[1;30;40mÀ-[[1;37mb[0;37mitch[0;36mx[1;30m]Ä>[0;37m "
...
#define DEFAULT_FORMAT_ACTION_CHANNEL_FSET                                     \
  ansi ? "%@%K* %Y$1/$3 %n$4-" : "* $1/$3 $4-"
#define DEFAULT_FORMAT_ACTION_OTHER_FSET                                       \
  ansi ? "%@%K* %n>%c$1 %n$3-" : "* >$1 $3-"
#define DEFAULT_FORMAT_ACTION_OTHER_AR_FSET                                    \
  ansi ? "%@%K* %Y>%c$1 %n$3-" : "* >$1 $3-"
#define DEFAULT_FORMAT_ACTION_USER_FSET                                        \
  ansi ? "%@%K* %n>%c$1 %n$3-" : "* >$1 $3-"
#define DEFAULT_FORMAT_ACTION_USER_AR_FSET                                     \
  ansi ? "%@%K* %Y>%c$1 %n$3-" : "* >$1 $3-"
...
#define DEFAULT_FORMAT_BANS_HEADER_FSET "#  Channel    SetBy        Sec  Ban"
#define DEFAULT_FORMAT_BANS_FSET                                               \
  "$[2]0 $[10]1 $[10]3 $[-5]numdiff($time() $4)  $2"
...
#define DEFAULT_FORMAT_CHANNEL_SIGNOFF_FSET                                    \
  "$G %nSignOff %W$1%n: $3 %K(%n$4-%K)"
...
#define DEFAULT_FORMAT_CTCP_UNKNOWN_FSET                                       \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested unknown ctcp $4- from $3"
#define DEFAULT_FORMAT_CTCP_UNKNOWN_USER_FSET                                  \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested unknown ctcp $4- from %g$3"
#define DEFAULT_FORMAT_CTCP_USER_FSET                                          \
  "%K>%n>%W> %G$1 %K[%g$2%K]%g requested $4- from you"
#define DEFAULT_FORMAT_CTCP_REPLY_FSET "$G %nCTCP %W$3 %nreply from %n$1: $4-"

#define DEFAULT_FORMAT_DCC_CHAT_FSET                                           \
  ansi ? "%@%K[%G$1%K(%gdcc%K)] %n$3-" : "%@[$1(dcc)] $3-"
#define DEFAULT_FORMAT_DCC_CHAT_AR_FSET                                        \
  ansi ? "%@%K[%Y$1%K(%Ydcc%K)] %n$3-" : "%@[$1(dcc)] $3-"
#define DEFAULT_FORMAT_DCC_CONNECT_FSET                                        \
  "$G %RDCC%n $1 with %W$2%K[%c$4:$5%K]%n established"
#define DEFAULT_FORMAT_DCC_ERROR_FSET                                          \
  "$G %RDCC%n lost %w$1%w %rto $2 %K[%w$3-%K]"
#define DEFAULT_FORMAT_DCC_LOST_FSET                                           \
  "%@$G %RDCC%n %W$1%n:%g$2%n %K[%C$3%K]%n $4 $5 completed in $6 secs "        \
  "%K(%W$7 $8/sec%K)"
#define DEFAULT_FORMAT_DCC_REQUEST_FSET                                        \
  "%@$G %RDCC%n $1 %K(%n$2%K)%n request from %W$3%K[%c$4 [$5:$6]%K]%n $8 $7"
#define DEFAULT_FORMAT_DESYNC_FSET "$G $1 is desynced from $2 at $0"
#define DEFAULT_FORMAT_DISCONNECT_FSET                                         \
  "$G Use %G/Server%n to connect to a server"
#define DEFAULT_FORMAT_ENCRYPTED_NOTICE_FSET "%@%K-%Y$1%K(%p$2%K)-%n $3-"
...
#define DEFAULT_FORMAT_INVITE_FSET "%K>%n>%W> $1 Invites You to $2-"
#define DEFAULT_FORMAT_INVITE_USER_FSET "%K>%n>%W> Inviting $1 to $2-"
#define DEFAULT_FORMAT_JOIN_FSET                                               \
  ansi ? "$G %C$1 %K[%c$2%K]%n has joined $3" : "$G $1 [$2] has joined $3"
#define DEFAULT_FORMAT_KICK_FSET "$G %n$3 was kicked off $2 by %c$1 %K(%n$4-%K)"
#define DEFAULT_FORMAT_KICK_USER_FSET                                          \
  "%K>%n>%W> %WYou%n have been kicked off %c$2%n by %c$1 %K(%n$4-%K)"
#define DEFAULT_FORMAT_KILL_FSET                                               \
  "%K>%n>%W> %RYou have been killed by $1 for $2-"
#define DEFAULT_FORMAT_LEAVE_FSET "$G $1 %K[%w$2%K]%n has left $3 %K[%W$4-%K]"

#ifdef ONLY_STD_CHARS
#define DEFAULT_FORMAT_LINKS_FSET                                              \
  "%K|%n$[24]0%K| |%n$[24]1%K| |%n$[3]2%K| |%n$[13]3-%K|"
#else
#define DEFAULT_FORMAT_LINKS_FSET                                              \
  "%K³%n$[24]0%K³ ³%n$[24]1%K³ ³%n$[3]2%K³ ³%n$[13]3-%K³"
#endif
...
#define DEFAULT_FORMAT_MODE_FSET                                               \
  ansi ? "$G %nmode%K/%c$3 %K[%W$4-%K]%n by %W$1" : "$G mode/$3 [$4-] by $1"
#define DEFAULT_FORMAT_SMODE_FSET "$G %RServerMode%K/%c$3 %K[%W$4-%K]%n by %W$1"

#define DEFAULT_FORMAT_MODE_CHANNEL_FSET                                       \
  "$G %nmode%K/%c$3 %K[%W$4-%K]%n by %W$1"

#define DEFAULT_FORMAT_MSG_FSET                                                \
  ansi ? "%@%K[%P$1%K(%p$2%K)]%n $3-" : "%@[$1($2)] $3-"
#define DEFAULT_FORMAT_MSG_AR_FSET                                             \
  ansi ? "%@%K[%Y$1%K(%Y$2%K)]%n $3-" : "%@[$1($2)] $3-"
...
#define DEFAULT_FORMAT_NAMES_FSET                                              \
  ansi ? "$G %K[%GUsers%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                         \
       : "$G [Users($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_BOT_FSET                                          \
  ansi ? "$G %K[%GBots%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                          \
       : "$G [Bots($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_FRIEND_FSET                                       \
  ansi ? "$G %K[%GFriends%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                       \
       : "$G [Friends($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_NONOP_FSET                                        \
  ansi ? "$G %K[%GNonChanOps%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                    \
       : "$G [NonChanOps($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_OP_FSET                                           \
  ansi ? "$G %K[%GChanOps%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                       \
       : "$G [ChanOps($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_IRCOP_FSET                                        \
  ansi ? "$G %K[%GIrcOps%K(%g$1%K:%g$2%K/%g$3%K)]%c $4"                        \
       : "$G [IrcOps($1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_SHIT_FSET                                         \
  ansi ? "$G %K[%MShitUsers%K(%m$1%K:%m$2%K/%m$3%K)]%c $4"                     \
       : "$G [ShitUsers(_$1:$2/$3)] $4"
#define DEFAULT_FORMAT_NAMES_VOICE_FSET                                        \
  ansi ? "$G %K[%MVoiceUsers%K(%m$1%K:%m$2%K/%m$3%K)]%c $4"                    \
       : "$G [VoiceUsers($1:$2/$3)] $4"
...
#define DEFAULT_FORMAT_NAMES_USER_CHANOP_FSET                                  \
  ansi ? "%K[%C$0%n$1-%K]" : "[$0$1-]"
#define DEFAULT_FORMAT_NAMES_USER_IRCOP_FSET                                   \
  ansi ? "%K[%R$0%n$1-%K]" : "[$0$1-]"
#define DEFAULT_FORMAT_NAMES_USER_VOICE_FSET                                   \
  ansi ? "%K[%M$0%n$1-%K]" : "[$0$1-]"

#define DEFAULT_FORMAT_NETADD_FSET "$G %nAdded: %W$1 $2"
#define DEFAULT_FORMAT_NETJOIN_FSET "$G %nNetjoined: %W$1 $2"
#define DEFAULT_FORMAT_NETSPLIT_FSET                                           \
  "$G %nNetSplit: %W$1%n split from %W$2 %K[%c$0%K]"
#define DEFAULT_FORMAT_NICKNAME_FSET "$G %W$1 %nis now known as %c$3"
#define DEFAULT_FORMAT_NICKNAME_OTHER_FSET "$G %W$1 %nis now known as %c$3"
#define DEFAULT_FORMAT_NICKNAME_USER_FSET                                      \
  "%K>%n>%W> %WYou%K(%n$1%K)%n are now known as %c$3"
#define DEFAULT_FORMAT_NONICK_FSET "%W$1%K:%n $3-"

#define DEFAULT_FORMAT_NOTE_FSET "($0) ($1) ($2) ($3) ($4) ($5-)"

#define DEFAULT_FORMAT_NOTICE_FSET                                             \
  ansi ? "%K-%P$1%K(%p$2%K)-%n $3-" : "-$1($2)- $3-"
...
#define DEFAULT_FORMAT_NOTIFY_SIGNON_FSET "$G %GSignon%n by %R$1%K!%R$2%n at $0"
#define DEFAULT_FORMAT_PASTE_FSET "%K[%W$1%K]%n $2-"
#define DEFAULT_FORMAT_PUBLIC_FSET                                             \
  ansi ? "%@%B<%n$1%B>%n $3-" : "%@<$1> $3-"
#define DEFAULT_FORMAT_PUBLIC_AR_FSET                                          \
  ansi ? "%@%B<%Y$1%B>%n $3-" : "%@<$1> $3-"
#define DEFAULT_FORMAT_PUBLIC_MSG_FSET                                         \
  ansi ? "%@%b(%n$1%K/%n$3%b)%n $4-" : "%@($1/$3) $4-"
#define DEFAULT_FORMAT_PUBLIC_MSG_AR_FSET                                      \
  ansi ? "%@%b(%Y$1%K/%Y$3%b)%n $4-" : "%@($1/$3) $4-"

#define DEFAULT_FORMAT_PUBLIC_NOTICE_FSET                                      \
  ansi ? "%@%K-%P$1%K:%p$3%K-%n $4-" : "%@-$1:$3- $4-"
#define DEFAULT_FORMAT_PUBLIC_NOTICE_AR_FSET                                   \
  ansi ? "%@%K-%Y$1%K:%Y$3%K-%n $4-" : "%@-$1:$3- $4-"

#define DEFAULT_FORMAT_PUBLIC_OTHER_FSET                                       \
  ansi ? "%@%b<%n$1%K:%n$2%b>%n $3-" : "%@<$1:$2> $3-"
#define DEFAULT_FORMAT_PUBLIC_OTHER_AR_FSET                                    \
  ansi ? "%@%b<%Y$1%K:%n$2%b>%n $3-" : "%@<$1:$2> $3-"
...
#define DEFAULT_FORMAT_SEND_AWAY_FSET                                          \
  "[Away ($strftime($1 %a %b %d %I:%M%p %Z))] [$tdiff2(${time() - u})] "       \
  "[BX-MsgLog $2]"
#define DEFAULT_FORMAT_SEND_CTCP_FSET                                          \
  ansi ? "%K[%rctcp%K(%R$1%K)] %n$2" : "[ctcp($1)] $2"
#define DEFAULT_FORMAT_SEND_RCTCP_FSET                                         \
  ansi ? "%K[%rrctcp%K(%R$1%K)] %n$2-" : "^B[rctcp(^B$1^B)]^B $2-"
#define DEFAULT_FORMAT_SEND_DCC_CHAT_FSET                                      \
  ansi ? "%K[%rdcc%K(%R$1%K)] %n$2-" : "[dcc($1)] $2-"
#define DEFAULT_FORMAT_SEND_ENCRYPTED_MSG_FSET "%K[%ymsg%K(%Y$1%K)] %n$3-"
#define DEFAULT_FORMAT_SEND_ENCRYPTED_NOTICE_FSET "%K[%ynotice%K(%Y$1%K)] %n$3-"
#define DEFAULT_FORMAT_SEND_ENCRYPTED_PUBLIC_FSET "%y<%n$2%K:%n$1%y>%n $3-"

#define DEFAULT_FORMAT_SEND_MSG_FSET                                           \
  ansi ? "%K[%rmsg%K(%R$1%K)] %n$3-" : "[msg($1)] $3-"
#define DEFAULT_FORMAT_SEND_NOTICE_FSET                                        \
  ansi ? "%K[%rnotice%K(%R$1%K)] %n$3-" : "[notice($1)] $3-"
#define DEFAULT_FORMAT_SEND_PUBLIC_FSET                                        \
  ansi ? "%P<%n$2%P>%n $3-" : "<$2> $3-"
#define DEFAULT_FORMAT_SEND_PUBLIC_OTHER_FSET                                  \
  ansi ? "%p<%n$2%K:%n$1%p>%n $3-" : "<$2:$1> $3-"
...
#define DEFAULT_FORMAT_TOPIC_CHANGE_FSET                                       \
  "$G Topic %K(%c$2%K):%n changed by %c$1%K:%n $3-"
#define DEFAULT_FORMAT_TOPIC_SETBY_FSET                                        \
  "$G Topic %K(%c$1%K):%n set by %c$2%n at %c$stime($3)%n"
...
#define DEFAULT_FORMAT_USERS_FSET                                              \
  "%K[%C$[1]5%B$[9]2%K][%n$[41]3%K][%n$[15]0%K](%n$4%K)"
#define DEFAULT_FORMAT_USERS_USER_FSET                                         \
  "%K[%C$[1]5%B$[9]2%K][%n%B$[41]3%K][%n$0%K](%n$4%K)"
#define DEFAULT_FORMAT_USERS_SHIT_FSET                                         \
  "%K[%C$[1]5%B$[9]2%K][%n%r$[41]3%K][%n$[-15]0%K](%n$4%K)"
#define DEFAULT_FORMAT_USERS_TITLE_FSET                                        \
  "$G Channel userlist for %W$1%n at ($0):"
#define DEFAULT_FORMAT_USERS_HEADER_FSET                                       \
  NULL /*"%K[ %WC%nhannel  %K][ %WN%wickname %K][%n %Wu%wser@host %K][%n                                                                        \
          %Wl%wevel         %K]"*/
...
#ifdef ONLY_STD_CHARS
#define DEFAULT_FORMAT_WHOIS_AWAY_FSET                                         \
  ansi ? "%K| %Wa%nway     : $0 - $1-" : "| away     : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_BOT_FSET                                          \
  ansi ? "%g| %Wb%not      : F:$0 $1-" : "| bot      : F:$0 $1-"
#define DEFAULT_FORMAT_WHOIS_CHANNELS_FSET                                     \
  ansi ? "%g| %Wc%nhannels : $0-" : "| channels : $0-"
#define DEFAULT_FORMAT_WHOIS_FRIEND_FSET                                       \
  ansi ? "%g| %Wf%nriend   : F:$0 $1-" : "| friend   : F:$0 $1-"
#define DEFAULT_FORMAT_WHOIS_HEADER_FSET                                       \
  ansi ? "%G.--------%g-%G--%g--%G-%g---------%K-%g--%K--%g-%K------------ "   \
         "--  -"                                                               \
       : ".----------------------------------------- --  -"
#define DEFAULT_FORMAT_WHOIS_IDLE_FSET                                         \
  ansi ? "%K: %Wi%ndle     : $0 hours $1 mins $2 secs (signon: $stime($3))"    \
       : ": idle     : $0 hours $1 mins $2 secs (signon: $stime($3))"
#define DEFAULT_FORMAT_WHOIS_SHIT_FSET                                         \
  ansi ? "%g| %Ws%nhit     : L:$0 [$1] $2 $3-"                                 \
       : "| shit     : L:$0 [$1] $2 $3-"
#define DEFAULT_FORMAT_WHOIS_SIGNON_FSET                                       \
  ansi ? "%K| %Ws%nignon   : $0-" : "| signon   : $0-"
#define DEFAULT_FORMAT_WHOIS_ACTUALLY_FSET                                     \
  ansi ? "%K: %Wa%nctually : $0-" : ": actually : $0-"
#define DEFAULT_FORMAT_WHOIS_CALLERID_FSET                                     \
  ansi ? "%K! %Wc%nallerid : $0-" : "! callerid : $0-"
#define DEFAULT_FORMAT_WHOIS_SECURE_FSET                                       \
  ansi ? "%K! %Ws%necure   : $0-" : "! secure   : $0-"
#define DEFAULT_FORMAT_WHOIS_NAME_FSET                                         \
  ansi ? "%G: %Wi%nrcname  : $0-" : ": ircname  : $0-"
#define DEFAULT_FORMAT_WHOIS_NICK_FSET                                         \
  ansi ? "%G| %W$0 %K(%n$1@$2%K) %K(%W$3-%K)" : "| $0 ($1@$2) ($3-)"
#define DEFAULT_FORMAT_WHOIS_OPER_FSET                                         \
  ansi ? "%K| %Wo%nperator : $0 $1-" : "| operator : $0 $1-"
#define DEFAULT_FORMAT_WHOIS_SERVER_FSET                                       \
  ansi ? "%K| %Ws%nerver   : $0 ($1-)" : "| server   : $0 ($1-)"
#define DEFAULT_FORMAT_WHOLEFT_HEADER_FSET                                     \
  ansi ? "%G.----- %WWho %G-----%g---%G---%g--%G-----%g--%G-- %WChannel%g--- " \
         "%wServer %G-%g----%G--%g--%G----%g %wSeconds"                        \
       : ".----- Who ---------------------- Channel--- Server "      \
         "------------- Seconds"
#define DEFAULT_FORMAT_WHOLEFT_USER_FSET                                       \
  ansi ? "%G|%n $[-10]0!$[20]1 $[10]2 $[20]4 $3"                               \
       : "| $[-10]0!$[20]1 $[10]2 $[20]4 $3"
#define DEFAULT_FORMAT_WHOWAS_HEADER_FSET                                      \
  ansi ? "%G.--------%g-%G--%g--%G-%g---------%K-%g--%K--%g-%K------------ "   \
         "--  -"                                                               \
       : ".----------------------------------------- --  -"
#define DEFAULT_FORMAT_WHOWAS_NICK_FSET                                        \
  ansi ? "%G| %W$0%n was %K(%n$1@$2%K)" : "| $0 was ($1@$2)"
#define DEFAULT_FORMAT_WHOIS_ADMIN_FSET                                        \
  ansi ? "%K| %Wa%ndmin    : $0 - $1-" : "| admin    : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_SERVICE_FSET                                      \
  ansi ? "%K| %Ws%nervice  : $0 - $1-" : "| service  : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_HELP_FSET                                         \
  ansi ? "%K| %Wh%nelp     : $0 - $1-" : "| help     : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_REGISTER_FSET                                     \
  ansi ? "%K| %Wr%negister : $0 - $1-" : "| register : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_LOGGEDIN_FSET                                     \
  ansi ? "%K: %Wl%noggedin : $0 $2- %W$1%n" : ": loggedin : $0 $2- $1"
#else
#define DEFAULT_FORMAT_WHOIS_AWAY_FSET                                         \
  ansi ? "%K| %Wa%nway     : $0 - $1-" : "| away     : $0 - $1-"
#define DEFAULT_FORMAT_WHOIS_BOT_FSET                                          \
...
#define DEFAULT_FORMAT_WHOIS_FRIEND_FSET                                       \
  ansi ? "%g| %Wf%nriend   : F:$0 $1-" : "| friend   : F:$0 $1-"
#define DEFAULT_FORMAT_WHOIS_HEADER_FSET                                       \
  ansi ? "%GÚÄÄÄÄÄ---%gÄ%G--%gÄÄ%G-%gÄÄÄÄÄÄ---%KÄ%g--%KÄÄ%g-%KÄÄÄÄÄÄÄÄÄ--- "   \
         "--  -"                                                               \
...
#define DEFAULT_FORMAT_WHOIS_SERVER_FSET                                       \
  ansi ? "%K³ %Ws%nerver   : $0 ($1-)" : "³ server   : $0 ($1-)"
#define DEFAULT_FORMAT_WHOLEFT_HEADER_FSET                                     \
  ansi ? "%GÚÄÄÄÄÄ %WWho %GÄÄÄÄÄ%g---%GÄÄÄ%g--%GÄÄÄÄÄ%gÄ-%GÄÄ %WChannel%gÄÄÄ " \
         "%wServer %G-%gÄÄ--%GÄÄ%g--%GÄÄÄÄ%g %wSeconds"                        \
       : "ÚÄÄÄÄÄ Who ÄÄÄÄÄ---ÄÄÄ--ÄÄÄÄÄÄ-ÄÄ ChannelÄÄÄ Server "      \
         "-ÄÄ--ÄÄ--ÄÄÄÄ Seconds"
#define DEFAULT_FORMAT_WHOLEFT_USER_FSET                                       \
  ansi ? "%G|%n $[-10]0!$[20]1 $[10]2 $[20]4 $3"                               \
       : "| $[-10]0!$[20]1 $[10]2 $[20]4 $3"
...
#define DEFAULT_FORMAT_OV_FSET                                                 \
  "[41m%S %>[1;30m[[1;32mOper[1;37mView[1;30;41m] "
...
#define DEFAULT_STATUS_FORMAT                                                  \
  " [0;44;36m[[1;37m%T[0;44;36m][%*%@%=[0;44;37m%N%#%A[0;44;36m]%M "      \
  "[0;44;36m[%C%+%W[0;44;36m] %Q %H%B%F "
#define DEFAULT_STATUS_FORMAT1                                                 \
  " [0;44;36m[[1;37m%T[0;44;36m][%*[1;37m%@%G%=[0;44;37m%N%#%A[0;44;"    \
  "36m]%M [0;44;36m[%C%+%W[0;44;36m] %Q %H%B%F "
#define DEFAULT_STATUS_FORMAT2 " %L %! %K %>%D %J[%u:%a:%f:%b:%h]"
#define DEFAULT_STATUS_FORMAT3 "BitchX by panasync "

#define DEFAULT_STATUS_AWAY                                                    \
  " [0;44;36m([1;32mzZzZ[1;37m %A[0;44;36m)[0;44;37m"
...
#define DEFAULT_STATUS_OPER_KILLS                                              \
  "[0;44;36m[[37mnk[36m/[1;37m%K [0;44mok[36m/[1;37m%K[0;44;36m]"
#define DEFAULT_STATUS_USERS                                                   \
  "[0;44;36m[[37mO[36m/[1;37m%! [0;44mN[36m/[1;37m%! "                  \
  "[0;44mI[36m/[1;37m%! [0;44mV[36m/[1;37m%! "                           \
  "[0;44mF[36m/[1;37m%![0;44;36m]"
#define DEFAULT_STATUS_CPU_SAVER " (%J)"
