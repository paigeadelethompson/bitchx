...
char *n_malloc_strcpy(char **, const char *, const char *, const char *,
                      const int);
char *BX_malloc_str2cpy(char **, const char *, const char *);
char *n_malloc_strcat(char **, const char *, const char *, const char *,
                      const int);
...
char *n_m_strcat_ues(char **, char *, int, const char *, const char *,
                     const int);
...
#define RESIZE(x, y, z)                                                        \
  ((x) = n_realloc((x), sizeof(y) * (z), MODULENAME, __FILE__, __LINE__))
#define malloc_strcpy(x, y)                                                    \
  n_malloc_strcpy((char **)x, (char *)y, MODULENAME, __FILE__, __LINE__)
#define malloc_strcat(x, y)                                                    \
  n_malloc_strcat((char **)x, (char *)y, MODULENAME, __FILE__, __LINE__)
#define m_strdup(x) n_m_strdup(x, MODULENAME, __FILE__, __LINE__)
#define m_strcat_ues(x, y, z)                                                  \
  n_m_strcat_ues(x, y, z, MODULENAME, __FILE__, __LINE__)
