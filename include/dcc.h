 ...
 */
#define DCC_PACKETID                                                           \
  0xfeab /* used to figure out endianess                                       \
          * as well as identify the resend                                     \
          * packet                                                             \
          */
#define MAX_DCC_BLOCK_SIZE                                                     \
  16384 /*                                                                     \
...
struct dcc_ops {
  int (*init)(const char *, const char *, const char *, const char *,
              const char *, const char *, unsigned long, unsigned short);
...
SocketList *BX_find_dcc(const char *, const char *, const char *, int, int, int,
                        int);
void BX_erase_dcc_info(int, int, char *, ...);
DCC_int *BX_dcc_create(char *, char *, char *, unsigned long, int, int,
                       unsigned long, void (*func)(int));
