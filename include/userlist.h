...
UserList *lookup_userlevelc(const char *, const char *, const char *,
                            const char *);
...
#define ADD_MASTER                                                             \
  (ADD_VOICE | ADD_OPS | ADD_BAN | ADD_UNBAN | ADD_INVITE | ADD_DCC | ADD_FLOOD)
...
UserList *find_bestmatch(const char *, const char *, const char *,
                         const char *);
