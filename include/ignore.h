...
#define IGNORE_ALL                                                             \
  (IGNORE_MSGS | IGNORE_PUBLIC | IGNORE_WALLS | IGNORE_WALLOPS |               \
   IGNORE_INVITES | IGNORE_NOTICES | IGNORE_NOTES | IGNORE_CTCPS |             \
   IGNORE_CRAP | IGNORE_CDCC | IGNORE_KICKS | IGNORE_MODES | IGNORE_SMODES |   \
   IGNORE_JOINS | IGNORE_TOPICS | IGNORE_QUITS | IGNORE_PARTS | IGNORE_NICKS | \
