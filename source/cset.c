...
static CSetArray cset_array[] = {
    ...
    {"AUTO_JOIN_ON_INVITE", BOOL_TYPE_VAR,
     offsetof(CSetList, set_auto_join_on_invite), NULL, 0},
    {"AUTO_LIMIT", INT_TYPE_VAR, offsetof(CSetList, set_auto_limit),
     limit_channel, 0},
    ...
    {"CHANNEL_LOG", BOOL_TYPE_VAR, offsetof(CSetList, channel_log), log_channel,
     0},
    {"CHANNEL_LOG_FILE", STR_TYPE_VAR, offsetof(CSetList, channel_log_file),
     NULL, 0},
    {"CHANNEL_LOG_LEVEL", STR_TYPE_VAR, offsetof(CSetList, log_level),
     set_msglog_channel_level, 0},
    {"COMPRESS_MODES", BOOL_TYPE_VAR, offsetof(CSetList, compress_modes), NULL,
     0},
    {"CTCP_FLOOD_BAN", BOOL_TYPE_VAR, offsetof(CSetList, set_ctcp_flood_ban),
     NULL, 0},
    {"DEOPFLOOD", BOOL_TYPE_VAR, offsetof(CSetList, set_deopflood), NULL, 0},
    {"DEOPFLOOD_TIME", INT_TYPE_VAR, offsetof(CSetList, set_deopflood_time),
     NULL, 0},
    {"DEOP_ON_DEOPFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_deop_on_deopflood), NULL, 0},
    {"DEOP_ON_KICKFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_deop_on_kickflood), NULL, 0},
    {"HACKING", INT_TYPE_VAR, offsetof(CSetList, set_hacking), NULL, 0},
    {"JOINFLOOD", BOOL_TYPE_VAR, offsetof(CSetList, set_joinflood), NULL, 0},
    {"JOINFLOOD_TIME", INT_TYPE_VAR, offsetof(CSetList, set_joinflood_time),
     NULL, 0},
    {"KICKFLOOD", BOOL_TYPE_VAR, offsetof(CSetList, set_kickflood), NULL, 0},
    {"KICKFLOOD_TIME", INT_TYPE_VAR, offsetof(CSetList, set_kickflood_time),
     NULL, 0},
    {"KICK_IF_BANNED", BOOL_TYPE_VAR, offsetof(CSetList, set_kick_if_banned),
     NULL, 0},
    {"KICK_ON_DEOPFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_kick_on_deopflood), NULL, 0},
    {"KICK_ON_JOINFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_kick_on_joinflood), NULL, 0},
    {"KICK_ON_KICKFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_kick_on_kickflood), NULL, 0},
    {"KICK_ON_NICKFLOOD", INT_TYPE_VAR,
     offsetof(CSetList, set_kick_on_nickflood), NULL, 0},
    {"KICK_ON_PUBFLOOD", INT_TYPE_VAR, offsetof(CSetList, set_kick_on_pubflood),
     NULL, 0},
    ...
    {"NICKFLOOD_TIME", INT_TYPE_VAR, offsetof(CSetList, set_nickflood_time),
     NULL, 0},
    {"PUBFLOOD", BOOL_TYPE_VAR, offsetof(CSetList, set_pubflood), NULL, 0},
    {"PUBFLOOD_IGNORE_TIME", INT_TYPE_VAR,
     offsetof(CSetList, set_pubflood_ignore), NULL, 0},
    {"PUBFLOOD_TIME", INT_TYPE_VAR, offsetof(CSetList, set_pubflood_time), NULL,
     0},
...
static WSetArray wset_array[] = {
    {"STATUS_AWAY", STR_TYPE_VAR, offsetof(WSet, status_away),
     offsetof(WSet, away_format), BX_build_status, 0},
    {"STATUS_CDCCCOUNT", STR_TYPE_VAR, offsetof(WSet, status_cdcccount),
     offsetof(WSet, cdcc_format), BX_build_status, 0},
    {"STATUS_CHANNEL", STR_TYPE_VAR, offsetof(WSet, status_channel),
     offsetof(WSet, channel_format), BX_build_status, 0},
    {"STATUS_CHANOP", STR_TYPE_VAR, offsetof(WSet, status_chanop), -1,
     BX_build_status, 0},
    {"STATUS_CLOCK", STR_TYPE_VAR, offsetof(WSet, status_clock),
     offsetof(WSet, clock_format), BX_build_status, 0},
    {"STATUS_CPU_SAVER", STR_TYPE_VAR, offsetof(WSet, status_cpu_saver),
     offsetof(WSet, cpu_saver_format), BX_build_status, 0},
    {"STATUS_DCCCOUNT", STR_TYPE_VAR, offsetof(WSet, status_dcccount),
     offsetof(WSet, dcccount_format), BX_build_status, 0},
    {"STATUS_FLAG", STR_TYPE_VAR, offsetof(WSet, status_flag),
     offsetof(WSet, flag_format), BX_build_status, 0},
    {"STATUS_FORMAT", STR_TYPE_VAR, offsetof(WSet, format_status), -1,
     BX_build_status, 0},
    {"STATUS_FORMAT1", STR_TYPE_VAR, offsetof(WSet, format_status[1]), -1,
     BX_build_status, 0},
    {"STATUS_FORMAT2", STR_TYPE_VAR, offsetof(WSet, format_status[2]), -1,
     BX_build_status, 0},
    {"STATUS_FORMAT3", STR_TYPE_VAR, offsetof(WSet, format_status[3]), -1,
     BX_build_status, 0},
    {"STATUS_HALFOP", STR_TYPE_VAR, offsetof(WSet, status_halfop), -1,
     BX_build_status, 0},
    {"STATUS_HOLD", STR_TYPE_VAR, offsetof(WSet, status_hold), -1,
     BX_build_status, 0},
    {"STATUS_HOLD_LINES", STR_TYPE_VAR, offsetof(WSet, status_hold_lines),
     offsetof(WSet, hold_lines_format), BX_build_status, 0},
    {"STATUS_LAG", STR_TYPE_VAR, offsetof(WSet, status_lag),
     offsetof(WSet, lag_format), BX_build_status, 0},
    {"STATUS_MAIL", STR_TYPE_VAR, offsetof(WSet, status_mail),
     offsetof(WSet, mail_format), BX_build_status, 0},
    {"STATUS_MODE", STR_TYPE_VAR, offsetof(WSet, status_mode),
     offsetof(WSet, mode_format), BX_build_status, 0},
    {"STATUS_MSGCOUNT", STR_TYPE_VAR, offsetof(WSet, status_msgcount),
     offsetof(WSet, msgcount_format), BX_build_status, 0},
    {"STATUS_NICK", STR_TYPE_VAR, offsetof(WSet, status_nick),
     offsetof(WSet, nick_format), BX_build_status, 0},
    {"STATUS_NOTIFY", STR_TYPE_VAR, offsetof(WSet, status_notify),
     offsetof(WSet, notify_format), BX_build_status, 0},
    {"STATUS_OPER_KILLS", STR_TYPE_VAR, offsetof(WSet, status_oper_kills),
     offsetof(WSet, kills_format), BX_build_status, 0},
    {"STATUS_QUERY", STR_TYPE_VAR, offsetof(WSet, status_query),
     offsetof(WSet, query_format), BX_build_status, 0},
    {"STATUS_SCROLLBACK", STR_TYPE_VAR, offsetof(WSet, status_scrollback), -1,
     BX_build_status, 0},
    {"STATUS_SERVER", STR_TYPE_VAR, offsetof(WSet, status_server),
     offsetof(WSet, server_format), BX_build_status, 0},
    {"STATUS_TOPIC", STR_TYPE_VAR, offsetof(WSet, status_topic),
     offsetof(WSet, topic_format), BX_build_status, 0},
    {"STATUS_UMODE", STR_TYPE_VAR, offsetof(WSet, status_umode),
     offsetof(WSet, umode_format), BX_build_status, 0},
    {"STATUS_USER0", STR_TYPE_VAR, offsetof(WSet, status_user_formats0), -1,
     BX_build_status, 0},
    {"STATUS_USER1", STR_TYPE_VAR, offsetof(WSet, status_user_formats1), -1,
     BX_build_status, 0},
    {"STATUS_USER10", STR_TYPE_VAR, offsetof(WSet, status_user_formats10), -1,
     BX_build_status, 0},
    {"STATUS_USER11", STR_TYPE_VAR, offsetof(WSet, status_user_formats11), -1,
     BX_build_status, 0},
    {"STATUS_USER12", STR_TYPE_VAR, offsetof(WSet, status_user_formats12), -1,
     BX_build_status, 0},
    {"STATUS_USER13", STR_TYPE_VAR, offsetof(WSet, status_user_formats13), -1,
     BX_build_status, 0},
    {"STATUS_USER14", STR_TYPE_VAR, offsetof(WSet, status_user_formats14), -1,
     BX_build_status, 0},
    {"STATUS_USER15", STR_TYPE_VAR, offsetof(WSet, status_user_formats15), -1,
     BX_build_status, 0},
    {"STATUS_USER16", STR_TYPE_VAR, offsetof(WSet, status_user_formats16), -1,
     BX_build_status, 0},
    {"STATUS_USER17", STR_TYPE_VAR, offsetof(WSet, status_user_formats17), -1,
     BX_build_status, 0},
    {"STATUS_USER18", STR_TYPE_VAR, offsetof(WSet, status_user_formats18), -1,
     BX_build_status, 0},
    {"STATUS_USER19", STR_TYPE_VAR, offsetof(WSet, status_user_formats19), -1,
     BX_build_status, 0},
    {"STATUS_USER2", STR_TYPE_VAR, offsetof(WSet, status_user_formats2), -1,
     BX_build_status, 0},
    {"STATUS_USER20", STR_TYPE_VAR, offsetof(WSet, status_user_formats20), -1,
     BX_build_status, 0},
    {"STATUS_USER21", STR_TYPE_VAR, offsetof(WSet, status_user_formats21), -1,
     BX_build_status, 0},
    {"STATUS_USER22", STR_TYPE_VAR, offsetof(WSet, status_user_formats22), -1,
     BX_build_status, 0},
    {"STATUS_USER23", STR_TYPE_VAR, offsetof(WSet, status_user_formats23), -1,
     BX_build_status, 0},
    {"STATUS_USER24", STR_TYPE_VAR, offsetof(WSet, status_user_formats24), -1,
     BX_build_status, 0},
    {"STATUS_USER25", STR_TYPE_VAR, offsetof(WSet, status_user_formats25), -1,
     BX_build_status, 0},
    {"STATUS_USER26", STR_TYPE_VAR, offsetof(WSet, status_user_formats26), -1,
     BX_build_status, 0},
    {"STATUS_USER27", STR_TYPE_VAR, offsetof(WSet, status_user_formats27), -1,
     BX_build_status, 0},
    {"STATUS_USER28", STR_TYPE_VAR, offsetof(WSet, status_user_formats28), -1,
     BX_build_status, 0},
    {"STATUS_USER29", STR_TYPE_VAR, offsetof(WSet, status_user_formats29), -1,
     BX_build_status, 0},
    {"STATUS_USER3", STR_TYPE_VAR, offsetof(WSet, status_user_formats3), -1,
     BX_build_status, 0},
    {"STATUS_USER30", STR_TYPE_VAR, offsetof(WSet, status_user_formats30), -1,
     BX_build_status, 0},
    {"STATUS_USER31", STR_TYPE_VAR, offsetof(WSet, status_user_formats31), -1,
     BX_build_status, 0},
    {"STATUS_USER32", STR_TYPE_VAR, offsetof(WSet, status_user_formats32), -1,
     BX_build_status, 0},
    {"STATUS_USER33", STR_TYPE_VAR, offsetof(WSet, status_user_formats33), -1,
     BX_build_status, 0},
    {"STATUS_USER34", STR_TYPE_VAR, offsetof(WSet, status_user_formats34), -1,
     BX_build_status, 0},
    {"STATUS_USER35", STR_TYPE_VAR, offsetof(WSet, status_user_formats35), -1,
     BX_build_status, 0},
    {"STATUS_USER36", STR_TYPE_VAR, offsetof(WSet, status_user_formats36), -1,
     BX_build_status, 0},
    {"STATUS_USER37", STR_TYPE_VAR, offsetof(WSet, status_user_formats37), -1,
     BX_build_status, 0},
    {"STATUS_USER38", STR_TYPE_VAR, offsetof(WSet, status_user_formats38), -1,
     BX_build_status, 0},
    {"STATUS_USER39", STR_TYPE_VAR, offsetof(WSet, status_user_formats39), -1,
     BX_build_status, 0},
    {"STATUS_USER4", STR_TYPE_VAR, offsetof(WSet, status_user_formats4), -1,
     BX_build_status, 0},
    {"STATUS_USER5", STR_TYPE_VAR, offsetof(WSet, status_user_formats5), -1,
     BX_build_status, 0},
    {"STATUS_USER6", STR_TYPE_VAR, offsetof(WSet, status_user_formats6), -1,
     BX_build_status, 0},
    {"STATUS_USER7", STR_TYPE_VAR, offsetof(WSet, status_user_formats7), -1,
     BX_build_status, 0},
    {"STATUS_USER8", STR_TYPE_VAR, offsetof(WSet, status_user_formats8), -1,
     BX_build_status, 0},
    {"STATUS_USER9", STR_TYPE_VAR, offsetof(WSet, status_user_formats9), -1,
     BX_build_status, 0},
    {"STATUS_USERS", STR_TYPE_VAR, offsetof(WSet, status_users),
     offsetof(WSet, status_users_format), BX_build_status, 0},
    {"STATUS_VOICE", STR_TYPE_VAR, offsetof(WSet, status_voice), -1,
     BX_build_status, 0},
    {"STATUS_WINDOW", STR_TYPE_VAR, offsetof(WSet, status_window), -1,
     BX_build_status, 0},
    {NULL, 0, 0, -1, NULL, 0}};
...
static int find_cset_variable(CSetArray *array, char *org_name, int *cnt) {
  ...
  if (first->name) {
    if (strlen(first->name) != (size_t)len) {
      v = first;
      for (v++; v->name; v++, (*cnt)++) {
...
static void set_cset_var_value(CSetList *tmp, int var_index, char *value) {
  ...
  case BOOL_TYPE_VAR:
    if (value && *value && (value = next_arg(value, &rest))) {
      ...
      if (var->func)
        var->func(var, tmp);
      put_it("%s", convert_output_format(fget_string_var(FORMAT_CSET_FSET),
                                         "%s %s %s", var->name, tmp->channel,
                                         get_cset_int_var(tmp, var_index)
                                             ? var_settings[ON]
                                             : var_settings[OFF]));
    } else
      put_it("%s", convert_output_format(fget_string_var(FORMAT_CSET_FSET),
  ...
  case STR_TYPE_VAR:
    if (value && *value) {
      ...
      put_it("%s", convert_output_format(fget_string_var(FORMAT_CSET_FSET),
                                         "%s %s %s", var->name, tmp->channel,
                                         get_cset_str_var(tmp, var_index)));
    } else
      put_it("%s", convert_output_format(
                       fget_string_var(FORMAT_CSET_FSET), "%s %s %s", var->name,
                       tmp->channel, (char *)get_cset_str_var(tmp, var_index)));
  }
}
...
static inline void cset_variable_range(char *channel, int cnt, int var_index,
                                       char *args) {
  ...
  if (current_window->server != -1) {
    for (chan = get_server_channels(current_window->server); chan;
         chan = chan->next) {
...
char *get_cset(char *var, ChannelList *chan, char *value) {
  ...
  if (cnt == 1) {
    ...
    *s = 0;
    ...
    case BOOL_TYPE_VAR: {
      strlcpy(s,
              get_cset_int_var(chan->csets, var_index) ? var_settings[ON]
                                                       : var_settings[OFF],
              sizeof(s));
      if (value) {
        int val = -1;
...
static void set_wset_var_value(Window *win, int var_index, char *value) {
  ...
  case STR_TYPE_VAR: {
    ...
    if ((val = get_wset_str_var_address(win->wset, var_index))) {
      ...
      if (var->func)
        (var->func)(win, *val, 0);
      say("Value of %s set to %s", var->name, *val ? *val : "<EMPTY>");
    }
  } break;
  default:
...
static inline void wset_variable_case1(Window *win, char *name, int var_index,
                                       char *args) {
  Window *tmp = NULL;
  int count = 0;
  int i;
...
static inline void wset_variable_casedef(Window *win, char *name, int cnt,
                                         int var_index, char *args) {
  Window *tmp = NULL;
  int count = 0;
  int c, i;
  if (!name) {
...
void set_channel_limit(ChannelList *channel, int currentlimit, int add,
                       int numusers) {
  if ((now - channel->limit_time) < 30)
    return;
  if (add && numusers) {
    if ((currentlimit - numusers) < (add / 2) &&
        ((numusers + add) != currentlimit))
      my_send_to_server(channel->server, "MODE %s +l %d", channel->channel,
                        numusers + add);
    else if ((currentlimit - numusers) > (currentlimit + (add / 2)) &&
             ((numusers + add) != currentlimit))
      my_send_to_server(channel->server, "MODE %s +l %d", channel->channel,
                        numusers + add);
  } else
...
#ifdef GUI
CSetArray *return_cset_var(int nummer) { return &cset_array[nummer]; }

WSetArray *return_wset_var(int nummer) { return &wset_array[nummer]; }
#endif
