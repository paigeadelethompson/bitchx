 ...
 */
void BX_add_to_list_ext(List **list, List *add,
 ...
 * is done
 */
List *BX_find_in_list_ext(register List **list, char *name, int wild,
                          int (*cmp_func)(List *, char *)) {
  register List *tmp;
 ...
 */
List *BX_remove_from_list_ext(List **list, char *name,
                              int (*cmp_func)(List *, char *)) {
  register List *tmp;
  List *last;
 ...
 * code
 */
List *BX_list_lookup_ext(register List **list, char *name, int wild, int delete,
                         int (*cmp_func)(List *, char *)) {
  register List *tmp;
