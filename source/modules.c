...
/* ircaux.c */
	global_table[MODULE_VERSION_CHECK].module_version_check_slot = BX_check_module_version;
	...
	global_table[REMOVE_TRAILING_SPACES].remove_trailing_spaces_slot = BX_remove_trailing_spaces;
	...
	global_table[TIME_TO_NEXT_MINUTE].time_to_next_minute_slot = BX_time_to_next_minute;
	...
	global_table[FIGURE_OUT_ADDRESS].figure_out_address_slot = BX_figure_out_address;
	...
	global_table[STRCPY_NOCOLORCODES].strcpy_nocolorcodes_slot = BX_strcpy_nocolorcodes;
	...
	global_table[NEXT_IN_COMMA_LIST].next_in_comma_list_slot = BX_next_in_comma_list;
...
/* list.c */
	...
	global_table[REMOVE_FROM_LIST_EXT].remove_from_list_ext_slot = BX_remove_from_list_ext;
	global_table[REMOVEWILD_FROM_LIST].removewild_from_list_slot = BX_removewild_from_list;
...
/* alist.c */
	...
	global_table[REMOVE_ALL_FROM_ARRAY].remove_all_from_array_slot = BX_remove_all_from_array;
	...
	global_table[FIND_FIXED_ARRAY_ITEM].find_fixed_array_item_slot = BX_find_fixed_array_item;


/* server.c */
	global_table[SEND_TO_SERVER].send_to_server_slot = BX_send_to_server;
	global_table[QUEUE_SEND_TO_SERVER].queue_send_to_server_slot = BX_queue_send_to_server;
...
/* connecting to the server */
	...
	global_table[CONNECT_TO_SERVER_BY_REFNUM].connect_to_server_by_refnum_slot = BX_connect_to_server_by_refnum;
	global_table[CLOSE_SERVER].close_server_slot = BX_close_server;
	global_table[IS_SERVER_CONNECTED].is_server_connected_slot = BX_is_server_connected;
	global_table[FLUSH_SERVER].flush_server_slot = BX_flush_server;
	global_table[SERVER_IS_CONNECTED].server_is_connected_slot = BX_server_is_connected;
...
/* server file reading */
	...
	global_table[ADD_TO_SERVER_LIST].add_to_server_list_slot = BX_add_to_server_list;
	global_table[BUILD_SERVER_LIST].build_server_list_slot = BX_build_server_list;
	global_table[DISPLAY_SERVER_LIST].display_server_list_slot = BX_display_server_list;
...
/* misc server/nickname functions */
	global_table[FIND_SERVER_REFNUM].find_server_refnum_slot = BX_find_server_refnum;
	global_table[FIND_IN_SERVER_LIST].find_in_server_list_slot = BX_find_in_server_list;
	global_table[PARSE_SERVER_INDEX].parse_server_index_slot = BX_parse_server_index;
	global_table[GET_SERVER_REDIRECT].get_server_redirect_slot = BX_get_server_redirect;
	global_table[SET_SERVER_REDIRECT].set_server_redirect_slot = BX_set_server_redirect;
	global_table[CHECK_SERVER_REDIRECT].check_server_redirect_slot = BX_check_server_redirect;
...
/* various set server struct functions */
	...
	global_table[UPDATE_SERVER_UMODE].update_server_umode_slot = BX_update_server_umode;
	global_table[SET_SERVER_MOTD].set_server_motd_slot = BX_set_server_motd;
	global_table[SET_SERVER_OPERATOR].set_server_operator_slot = BX_set_server_operator;
	global_table[SET_SERVER_ITSNAME].set_server_itsname_slot = BX_set_server_itsname;
	global_table[SET_SERVER_VERSION].set_server_version_slot = BX_set_server_version;
	global_table[SET_SERVER_LAG].set_server_lag_slot = BX_set_server_lag;
	global_table[SET_SERVER_PASSWORD].set_server_password_slot = BX_set_server_password;
	global_table[SET_SERVER_NICKNAME].set_server_nickname_slot = BX_set_server_nickname;
...
/* various get server struct functions */
	...
	global_table[GET_SERVER_NICKNAME].get_server_nickname_slot = BX_get_server_nickname;
	global_table[GET_SERVER_NAME].get_server_name_slot = BX_get_server_name;
	global_table[GET_SERVER_ITSNAME].get_server_itsname_slot = BX_get_server_itsname;
	global_table[GET_SERVER_MOTD].get_server_motd_slot = BX_get_server_motd;
	global_table[GET_SERVER_OPERATOR].get_server_operator_slot = BX_get_server_operator;
	global_table[GET_SERVER_VERSION].get_server_version_slot = BX_get_server_version;
	...
	global_table[GET_SERVER_NETWORK].get_server_network_slot = BX_get_server_network;
	global_table[GET_PENDING_NICKNAME].get_pending_nickname_slot = BX_get_pending_nickname;
	...
	global_table[GET_SERVER_CHANNELS].get_server_channels_slot = BX_get_server_channels;
	global_table[SET_SERVER_LAST_CTCP_TIME].set_server_last_ctcp_time_slot = BX_set_server_last_ctcp_time;
	global_table[GET_SERVER_LAST_CTCP_TIME].get_server_last_ctcp_time_slot = BX_get_server_last_ctcp_time;
	global_table[SET_SERVER_TRACE_FLAG].set_server_trace_flag_slot = BX_set_server_trace_flag;
	global_table[GET_SERVER_TRACE_FLAG].get_server_trace_flag_slot = BX_get_server_trace_flag;
	global_table[SET_SERVER_STAT_FLAG].set_server_stat_flag_slot = BX_set_server_stat_flag;
	global_table[GET_SERVER_STAT_FLAG].get_server_stat_flag_slot = BX_get_server_stat_flag;
	global_table[GET_SERVER_READ].get_server_read_slot = BX_get_server_read;
	global_table[GET_SERVER_LINKLOOK].get_server_linklook_slot = BX_get_server_linklook;
	global_table[SET_SERVER_LINKLOOK].set_server_linklook_slot = BX_set_server_linklook;
	global_table[GET_SERVER_LINKLOOK_TIME].get_server_linklook_time_slot = BX_get_server_linklook_time;
	global_table[SET_SERVER_LINKLOOK_TIME].set_server_linklook_time_slot = BX_set_server_linklook_time;
	global_table[GET_SERVER_TRACE_KILL].get_server_trace_kill_slot = BX_get_server_trace_kill;
	global_table[SET_SERVER_TRACE_KILL].set_server_trace_kill_slot = BX_set_server_trace_kill;
	global_table[ADD_SERVER_CHANNELS].add_server_channels_slot = BX_add_server_channels;
	global_table[SET_SERVER_CHANNELS].set_server_channels_slot = BX_set_server_channels;
	global_table[SEND_MSG_TO_CHANNELS].send_msg_to_channels_slot = BX_send_msg_to_channels;
...
/* screen.c */
	...
	global_table[SKIP_INCOMING_MIRC].skip_incoming_mirc_slot = BX_skip_incoming_mirc;
	...
	global_table[CURSOR_NOT_IN_DISPLAY].cursor_not_in_display_slot = BX_cursor_not_in_display;
	global_table[CURSOR_IN_DISPLAY].cursor_in_display_slot = BX_cursor_in_display;
	global_table[IS_CURSOR_IN_DISPLAY].is_cursor_in_display_slot = BX_is_cursor_in_display;
...
#ifdef WINDOW_CREATE
	global_table[CREATE_ADDITIONAL_SCREEN].create_additional_screen_slot = BX_create_additional_screen;
...
/* window.c */
	global_table[GET_WINDOW_BY_NAME].get_window_by_name_slot = BX_get_window_by_name;
	global_table[GET_CURRENT_CHANNEL_BY_REFNUM].get_current_channel_by_refnum_slot = BX_get_current_channel_by_refnum;
	...
	global_table[UPDATE_ALL_WINDOWS].update_all_windows_slot = BX_update_all_windows;
	global_table[SET_SCREENS_CURRENT_WINDOW].set_screens_current_window_slot = BX_set_screens_current_window;
	...
	global_table[REMOVE_WINDOW_FROM_SCREEN].remove_window_from_screen_slot = BX_remove_window_from_screen;
	global_table[TRAVERSE_ALL_WINDOWS].traverse_all_windows_slot = BX_traverse_all_windows;
	global_table[ADD_TO_INVISIBLE_LIST].add_to_invisible_list_slot = BX_add_to_invisible_list;
	global_table[ADD_TO_WINDOW_LIST].add_to_window_list_slot = BX_add_to_window_list;
	global_table[RECALCULATE_WINDOW_POSITIONS].recalculate_window_positions_slot = BX_recalculate_window_positions;
	global_table[MOVE_WINDOW].move_window_slot = BX_move_window;
	global_table[REDRAW_ALL_WINDOWS].redraw_all_windows_slot = BX_redraw_all_windows;
	global_table[REBALANCE_WINDOWS].rebalance_windows_slot = BX_rebalance_windows;
	global_table[RECALCULATE_WINDOWS].recalculate_windows_slot = BX_recalculate_windows;
	global_table[GOTO_WINDOW].goto_window_slot = BX_goto_window;
	global_table[HIDE_BX_WINDOW].hide_bx_window_slot = BX_hide_window;
	global_table[FUNC_SWAP_LAST_WINDOW].func_swap_last_window_slot = BX_swap_last_window;
	global_table[FUNC_SWAP_NEXT_WINDOW].func_swap_next_window_slot = BX_swap_next_window;
	global_table[FUNC_SWAP_PREVIOUS_WINDOW].func_swap_previous_window_slot = BX_swap_previous_window;
	global_table[SHOW_WINDOW].show_window_slot = BX_show_window;
	global_table[GET_STATUS_BY_REFNUM].get_status_by_refnum_slot = BX_get_status_by_refnum;
	global_table[GET_WINDOW_BY_DESC].get_window_by_desc_slot = BX_get_window_by_desc;
	global_table[GET_WINDOW_BY_REFNUM].get_window_by_refnum_slot = BX_get_window_by_refnum;
	global_table[GET_VISIBLE_BY_REFNUM].get_visible_by_refnum_slot = BX_get_visible_by_refnum;
	global_table[FUNC_NEXT_WINDOW].func_next_window_slot = BX_next_window;
	global_table[FUNC_PREVIOUS_WINDOW].func_previous_window_slot = BX_previous_window;
	global_table[UPDATE_WINDOW_STATUS].update_window_status_slot = BX_update_window_status;
	global_table[UPDATE_ALL_STATUS].update_all_status_slot = BX_update_all_status;
	global_table[UPDATE_WINDOW_STATUS_ALL].update_window_status_all_slot = BX_update_window_status_all;
	global_table[STATUS_UPDATE].status_update_slot = BX_status_update;
	global_table[SET_PROMPT_BY_REFNUM].set_prompt_by_refnum_slot = BX_set_prompt_by_refnum;
	global_table[GET_PROMPT_BY_REFNUM].get_prompt_by_refnum_slot = BX_get_prompt_by_refnum;
	...
	global_table[GET_TARGET_BY_REFNUM].get_target_by_refnum_slot = BX_get_target_by_refnum;
	global_table[GET_TARGET_CMD_BY_REFNUM].get_target_cmd_by_refnum_slot = BX_get_target_cmd_by_refnum;
	global_table[GET_WINDOW_TARGET_BY_DESC].get_window_target_by_desc_slot = BX_get_window_target_by_desc;
	global_table[IS_CURRENT_CHANNEL].is_current_channel_slot = BX_is_current_channel;
	global_table[SET_CURRENT_CHANNEL_BY_REFNUM].set_current_channel_by_refnum_slot = BX_set_current_channel_by_refnum;
	global_table[GET_REFNUM_BY_WINDOW].get_refnum_by_window_slot = BX_get_refnum_by_window;
	global_table[IS_BOUND_TO_WINDOW].is_bound_to_window_slot = BX_is_bound_to_window;
	global_table[GET_WINDOW_BOUND_CHANNEL].get_window_bound_channel_slot = BX_get_window_bound_channel;
	...
	global_table[WINDOW_CHECK_SERVERS].window_check_servers_slot = BX_window_check_servers;
	global_table[CHANGE_WINDOW_SERVER].change_window_server_slot = BX_change_window_server;
	global_table[SET_LEVEL_BY_REFNUM].set_level_by_refnum_slot = BX_set_level_by_refnum;
	...
	global_table[CLEAR_WINDOW_BY_REFNUM].clear_window_by_refnum_slot = BX_clear_window_by_refnum;
	global_table[UNCLEAR_WINDOW_BY_REFNUM].unclear_window_by_refnum_slot = BX_unclear_window_by_refnum;
	global_table[SET_SCROLL_LINES].set_scroll_lines_slot = BX_set_scroll_lines;
	global_table[SET_CONTINUED_LINES].set_continued_lines_slot = BX_set_continued_lines;
	global_table[CURRENT_REFNUM].current_refnum_slot = BX_current_refnum;
	global_table[NUMBER_OF_WINDOWS_ON_SCREEN].number_of_windows_on_screen_slot = BX_number_of_windows_on_screen;
	global_table[SET_SCROLLBACK_SIZE].set_scrollback_size_slot = BX_set_scrollback_size;
	global_table[IS_WINDOW_NAME_UNIQUE].is_window_name_unique_slot = BX_is_window_name_unique;
	global_table[GET_NICKLIST_BY_WINDOW].get_nicklist_by_window_slot = BX_get_nicklist_by_window;
	global_table[SCROLLBACK_BACKWARDS_LINES].scrollback_backwards_lines_slot = BX_scrollback_backwards_lines;
	global_table[SCROLLBACK_FORWARDS_LINES].scrollback_forwards_lines_slot = BX_scrollback_forwards_lines;
	global_table[SCROLLBACK_FORWARDS].scrollback_forwards_slot = BX_scrollback_forwards;
	global_table[SCROLLBACK_BACKWARDS].scrollback_backwards_slot = BX_scrollback_backwards;
	...
	global_table[FUNC_UNSTOP_ALL_WINDOWS].func_unstop_all_windows_slot = BX_unstop_all_windows;
	global_table[RESET_LINE_CNT].reset_line_cnt_slot = BX_reset_line_cnt;
	global_table[FUNC_TOGGLE_STOP_SCREEN].func_toggle_stop_screen_slot = BX_toggle_stop_screen;
	global_table[FLUSH_EVERYTHING_BEING_HELD].flush_everything_being_held_slot = BX_flush_everything_being_held;
	global_table[UNHOLD_A_WINDOW].unhold_a_window_slot = BX_unhold_a_window;
	global_table[RECALCULATE_WINDOW_CURSOR].recalculate_window_cursor_slot = BX_recalculate_window_cursor;
	global_table[MAKE_WINDOW_CURRENT].make_window_current_slot = BX_make_window_current;
	global_table[CLEAR_SCROLLBACK].clear_scrollback_slot = BX_clear_scrollback;
	
	global_table[RESET_DISPLAY_TARGET].reset_display_target_slot = BX_reset_display_target;
	global_table[SET_DISPLAY_TARGET].set_display_target_slot = BX_set_display_target;
	global_table[SAVE_DISPLAY_TARGET].save_display_target_slot = BX_save_display_target;
	global_table[RESTORE_DISPLAY_TARGET].restore_display_target_slot = BX_restore_display_target;
	...
	global_table[CONVERT_OUTPUT_FORMAT].convert_output_format_slot = BX_convert_output_format;
	...
	global_table[SET_LASTLOG_MSG_LEVEL].set_lastlog_msg_level_slot = BX_set_lastlog_msg_level;


/* module.c */
#ifdef WANT_DLL
	global_table[REMOVE_MODULE_PROC].remove_module_proc_slot = BX_remove_module_proc;
...
/* alias.c */
	...
	global_table[UNLOCK_STACK_FRAME].unlock_stack_frame_slot = BX_unlock_stack_frame;
...
/* input.c */	
	...
	global_table[LOOKUP_NICKCOMPLETION].lookup_nickcompletion_slot = BX_lookup_nickcompletion;
	global_table[ADD_COMPLETION_TYPE].add_completion_type_slot = BX_add_completion_type;
...
/* names.c */			
	...
	global_table[MAKE_CHANNEL].generic = (void *)BX_make_channel; /* this is really in misc.c */
	...
	global_table[FUNC_COMPRESS_MODES].func_compress_modes_slot = BX_do_compress_modes;
#endif
	...
	global_table[REMOVE_FROM_CHANNEL].remove_from_channel_slot = BX_remove_from_channel;
	...
	global_table[GET_CHANNEL_HALFOP].get_channel_halfop_slot = BX_get_channel_halfop;
	...
	global_table[CREATE_CHANNEL_LIST].create_channel_list_slot = BX_create_channel_list;
	global_table[FLUSH_CHANNEL_STATS].flush_channel_stats_slot = BX_flush_channel_stats;
	global_table[LOOKUP_CHANNEL].lookup_channel_slot = BX_lookup_channel;
				
/* hash.c */
	global_table[FIND_NICKLIST_IN_CHANNELLIST].find_nicklist_in_channellist_slot = BX_find_nicklist_in_channellist;
	global_table[ADD_NICKLIST_TO_CHANNELLIST].add_nicklist_to_channellist_slot = BX_add_nicklist_to_channellist;
	...
	global_table[ADD_NAME_TO_GENERICLIST].add_name_to_genericlist_slot = BX_add_name_to_genericlist;
	global_table[FIND_NAME_IN_GENERICLIST].find_name_in_genericlist_slot = BX_find_name_in_genericlist;
	global_table[ADD_WHOWAS_USERHOST_CHANNEL].add_whowas_userhost_channel_slot = BX_add_whowas_userhost_channel;
	global_table[FIND_USERHOST_CHANNEL].find_userhost_channel_slot = BX_find_userhost_channel;
	...
	global_table[CLEAR_SORTED_NICKLIST].clear_sorted_nicklist_slot = BX_clear_sorted_nicklist;
	global_table[ADD_NAME_TO_FLOODLIST].add_name_to_floodlist_slot = BX_add_name_to_floodlist;
	global_table[FIND_NAME_IN_FLOODLIST].find_name_in_floodlist_slot = BX_find_name_in_floodlist;
	global_table[REMOVE_OLDEST_WHOWAS_HASHLIST].remove_oldest_whowas_hashlist_slot = BX_remove_oldest_whowas_hashlist;
...
/* vars.h cset.c fset.c */
	...
	global_table[GET_WSET_STRING_VAR].get_wset_string_var_slot = BX_get_wset_string_var;
	global_table[SET_WSET_STRING_VAR].set_wset_string_var_slot = BX_set_wset_string_var;
...
/* alias.c */
	...
	global_table[ALIAS_SPECIAL_CHAR].alias_special_char_slot = BX_alias_special_char;
	...
	global_table[DESTROY_LOCAL_STACK].destroy_local_stack_slot = BX_destroy_local_stack;
...
/* dcc.c */
	...
	global_table[REMOVE_ALL_DCC_BINDS].remove_all_dcc_binds_slot = BX_remove_all_dcc_binds;
	...
	global_table[DCC_CHAT_SOCKETREAD].dcc_chat_socketread_slot = BX_dcc_chat_socketread;
	global_table[DCC_SEND_SOCKETREAD].dcc_send_socketread_slot = BX_dcc_send_socketread;
...
/* who.c */
	...
	global_table[DEFAULT_OUTPUT_FUNCTION].default_output_function_slot = default_output_function;
	global_table[DEFAULT_STATUS_OUTPUT_FUNCTION].default_status_output_function_slot = &default_status_output_function;


/* important variables */
	static char *nickname_ptr = nickname;
	static char *irc_version_ptr = irc_version;
	global_table[NICKNAME].nickname_slot = &nickname_ptr;
	global_table[IRC_VERSION].irc_version_slot = &irc_version_ptr;
	global_table[FROM_SERVER].from_server_slot = &from_server;
	global_table[CONNECTED_TO_SERVER].connected_to_server_slot = &connected_to_server;
	global_table[PRIMARY_SERVER].primary_server_slot = &primary_server;
	global_table[PARSING_SERVER_INDEX].parsing_server_index_slot = &parsing_server_index;
	...
	global_table[WINDOW_DISPLAY].window_display_slot = &window_display;
	global_table[STATUS_UPDATE_FLAG].status_update_flag_slot = &status_update_flag;
