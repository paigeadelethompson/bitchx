...
void add_channel_grep(char *channel, char *what, int flag) {
  ...
  while (channel) {
    ...
    if (chan &&
        !(new = (Ignore *)list_lookup((List **)&ignored_nicks, chan,
                                      !USE_WILDCARDS, !REMOVE_FROM_LIST))) {
      Ignore *tmp, *old;
      char *s;
      if ((new = (Ignore *)remove_from_list((List **)&ignored_nicks,
                                            channel)) != NULL) {
        new_free(&(new->nick));
...
void ignore_nickname(char *nick, long type, int flag) {
  ...
  while (nick) {
    ...
    if (*nick) {
      ...
      if (!(new = (Ignore *)list_lookup((List **)&ignored_nicks, new_nick,
                                        !USE_WILDCARDS, !REMOVE_FROM_LIST))) {
...
static int remove_ignore(char *nick) {
   ...
   */
  if ((tmp = (Ignore *)list_lookup((List **)&ignored_nicks, new_nick,
   ...
   */
    ...
    while ((tmp = (Ignore *)list_lookup((List **)&ignored_nicks, new_nick,
                                        USE_WILDCARDS, REMOVE_FROM_LIST)) !=
           NULL) {
      say("%s removed from ignore list", tmp->nick);
      new_free(&(tmp->nick));
...
int check_is_ignored(char *nick) {
  ...
  if (ignored_nicks) {
    if ((tmp = (Ignore *)list_lookup((List **)&ignored_nicks, nick,
                                     USE_WILDCARDS, !REMOVE_FROM_LIST)) != NULL)
      return 1;
  }
  return 0;
    ...
    for (tmp = ignored_nicks; tmp; tmp = tmp->next) {
      ...
      *buffer = 0;
      if (tmp->type == IGNORE_ALL)
        ...
        strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "ALL",
                    highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_PUBLIC)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "PUBLIC",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_MSGS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "MSG",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_WALLS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "WALL",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_WALLOPS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "WALLOPS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_INVITES)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "INVITES",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_NOTICES)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "NOTICES",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_NOTES)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "NOTES",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_CTCPS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "CTCPS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_CDCC)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "CDCC",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_KICKS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "KICKS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_MODES)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "MODES",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_SMODES)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "SMODES",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_JOINS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "JOINS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_TOPICS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "TOPICS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_QUITS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "QUITS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_PARTS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "PARTS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_NICKS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "NICKS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_PONGS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "PONGS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_SPLITS)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "SPLITS",
                      highlight_char, NULL);
        ...
        if (tmp->type & IGNORE_CRAP)
          ...
          strmopencat(buffer, BIG_BUFFER_SIZE, space, highlight_char, "CRAP",
                      highlight_char, NULL);
      ...
      put_it("%s",
             convert_output_format("  %K[%G$[-2]0%K] %C$[-25]1%W:%n $2-",
                                   "%d %s %s", tmp->num, tmp->nick, buffer));
    }
  } else
...
int ignore_exception(Ignore *old, char *args) {
  ...
  int flag = 0;
  if (args &&
      !(new = (Ignore *)list_lookup((List **)&old->except, args, !USE_WILDCARDS,
                                    !REMOVE_FROM_LIST))) {
...
NOTICES NOTES CTCPS CDCC KICKS MODES SMODES JOINS TOPICS QUITS PARTS NICKS PONGS SQUITS CRAP NONE");
      ...
      } else if ((flag == IGNORE_CGREP) &&
                 ((ret = ignore_type(type, len)) != -1))
 ...
 */
void set_highlight_char(Window *win __attribute__((unused)), char *s, int unused __attribute__((unused))) {
  int len = strlen(s);
 ...
 * (jfn may 1995)
 */
int check_ignore(char *nick, char *userhost, char *channel, long type,
                 char *str) {
  char *nickuserhost = NULL;
  Ignore *tmp;

  malloc_sprintf(&nickuserhost, "%s!%s", nick ? nick : "*",
                 userhost ? userhost : "*");

  if (ignored_nicks) {
    if ((tmp = (Ignore *)list_lookup((List **)&ignored_nicks, nickuserhost,
                                     USE_WILDCARDS, !REMOVE_FROM_LIST))) {
      if (tmp->except && list_lookup((List **)&tmp->except, nickuserhost,
                                     USE_WILDCARDS, !REMOVE_FROM_LIST)) {
...
void tremove_ignore(char *stuff __attribute__((unused)), char *line) {
  int count = 0;
  Ignore *new, *newc, *ex;
  char *p;
  int except = 0;
...
BUILT_IN_COMMAND(tignore) {
  ...
  if (ignored_nicks) {
    if (args && *args)
      ...
      add_wait_prompt("Which ignore to delete (-2, 2-5, ...) ? ",
                      tremove_ignore, args, WAIT_PROMPT_LINE, 1);
  }
}
