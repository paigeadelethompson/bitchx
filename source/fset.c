...
void add_new_fset(char *name, char *args) {
  if (args && *args) {
    ...
    int cnt, loc;
    tmp = (IrcVariable *)find_array_item((Array *)&ext_fset_list, name, &cnt,
                                         &loc);
    if (!tmp || cnt >= 0) {
    ...
    IrcVariable *tmp;
    if ((tmp =
             (IrcVariable *)remove_from_array((Array *)&ext_fset_list, name))) {
      new_free(&tmp->name);
      new_free(&tmp->string);
      new_free(&tmp);
    }
...
IrcVariable *find_ext_fset_var(char *name) {
  ...
  int loc, cnt;
  tmp =
      (IrcVariable *)find_array_item((Array *)&ext_fset_list, name, &cnt, &loc);
  if (tmp && cnt < 0)
    return tmp;
  return NULL;
}
    ...
    if (value) {
      if (*value)
        ...
        put_it("%s", convert_output_format(
                         ...
                         var->string ? var->string : empty_string));
        return;
      }
    } else
      new_free(&(var->string));
...
static inline void fset_variable_casedef(char *name, int cnt, int var_index,
                                         char *args) {
  FsetNumber *tmp;
  ...
  for (tmp = numeric_fset; tmp; tmp = tmp->next)
    if (my_atol(name) == tmp->numeric)
      put_it("%s", convert_output_format(fget_string_var(FORMAT_SET_FSET),
                                         "%d %s", tmp->numeric, tmp->format));
}

static inline void fset_variable_noargs(char *name __attribute__((unused))) {
  int var_index = 0;
  FsetNumber *tmp;
  ...
  for (var_index = 0; var_index < ext_fset_list.max; var_index++)
    set_fset_var_value(var_index, (*ext_fset_list.list[var_index]).name,
                       empty_string);
  for (tmp = numeric_fset; tmp; tmp = tmp->next)
    put_it("%s", convert_output_format(fget_string_var(FORMAT_SET_FSET),
                                       "%d %s", tmp->numeric, tmp->format));
...
void create_fsets(Window *win __attribute__((unused)), int ansi) {
#ifdef VAR_DEBUG
  int i;
  ...
  fset_string_var(FORMAT_ACTION_CHANNEL_FSET,
                  DEFAULT_FORMAT_ACTION_CHANNEL_FSET);
  fset_string_var(FORMAT_ACTION_OTHER_FSET, DEFAULT_FORMAT_ACTION_OTHER_FSET);
  fset_string_var(FORMAT_ACTION_OTHER_AR_FSET,
                  DEFAULT_FORMAT_ACTION_OTHER_AR_FSET);
  fset_string_var(FORMAT_ACTION_USER_FSET, DEFAULT_FORMAT_ACTION_USER_FSET);
  fset_string_var(FORMAT_ACTION_USER_AR_FSET,
                  DEFAULT_FORMAT_ACTION_USER_AR_FSET);
  ...
  fset_string_var(FORMAT_CHANNEL_SIGNOFF_FSET,
                  DEFAULT_FORMAT_CHANNEL_SIGNOFF_FSET);
  ...
  fset_string_var(FORMAT_CTCP_CLOAK_FUNC_FSET,
                  DEFAULT_FORMAT_CTCP_CLOAK_FUNC_FSET);
  fset_string_var(FORMAT_CTCP_CLOAK_FUNC_USER_FSET,
                  DEFAULT_FORMAT_CTCP_CLOAK_FUNC_USER_FSET);
  fset_string_var(FORMAT_CTCP_CLOAK_UNKNOWN_FSET,
                  DEFAULT_FORMAT_CTCP_CLOAK_UNKNOWN_FSET);
  fset_string_var(FORMAT_CTCP_CLOAK_UNKNOWN_USER_FSET,
                  DEFAULT_FORMAT_CTCP_CLOAK_UNKNOWN_USER_FSET);
  fset_string_var(FORMAT_CTCP_CLOAK_USER_FSET,
                  DEFAULT_FORMAT_CTCP_CLOAK_USER_FSET);
  fset_string_var(FORMAT_CTCP_FUNC_FSET, DEFAULT_FORMAT_CTCP_FUNC_FSET);
  fset_string_var(FORMAT_CTCP_FUNC_USER_FSET,
                  DEFAULT_FORMAT_CTCP_FUNC_USER_FSET);
  fset_string_var(FORMAT_CTCP_UNKNOWN_FSET, DEFAULT_FORMAT_CTCP_UNKNOWN_FSET);
  fset_string_var(FORMAT_CTCP_UNKNOWN_USER_FSET,
                  DEFAULT_FORMAT_CTCP_UNKNOWN_USER_FSET);
  ...
  fset_string_var(FORMAT_ENCRYPTED_NOTICE_FSET,
                  DEFAULT_FORMAT_ENCRYPTED_NOTICE_FSET);
  fset_string_var(FORMAT_ENCRYPTED_PRIVMSG_FSET,
                  DEFAULT_FORMAT_ENCRYPTED_PRIVMSG_FSET);
  fset_string_var(FORMAT_ENCRYPTED_PUBLIC_FSET,
                  DEFAULT_FORMAT_ENCRYPTED_PUBLIC_FSET);
  fset_string_var(FORMAT_ENCRYPTED_PUBLIC_NOTICE_FSET,
                  DEFAULT_FORMAT_ENCRYPTED_PUBLIC_NOTICE_FSET);
  ...
  fset_string_var(FORMAT_IGNORE_MSG_AWAY_FSET,
                  DEFAULT_FORMAT_IGNORE_MSG_AWAY_FSET);
  ...
  fset_string_var(FORMAT_NAMES_NICK_BOT_FSET,
                  DEFAULT_FORMAT_NAMES_NICK_BOT_FSET);
  fset_string_var(FORMAT_NAMES_NICK_FRIEND_FSET,
                  DEFAULT_FORMAT_NAMES_NICK_FRIEND_FSET);
  fset_string_var(FORMAT_NAMES_NICK_ME_FSET, DEFAULT_FORMAT_NAMES_NICK_ME_FSET);
  fset_string_var(FORMAT_NAMES_NICK_SHIT_FSET,
                  DEFAULT_FORMAT_NAMES_NICK_SHIT_FSET);
  ...
  fset_string_var(FORMAT_NAMES_USER_CHANOP_FSET,
                  DEFAULT_FORMAT_NAMES_USER_CHANOP_FSET);
  fset_string_var(FORMAT_NAMES_USER_IRCOP_FSET,
                  DEFAULT_FORMAT_NAMES_USER_IRCOP_FSET);
  fset_string_var(FORMAT_NAMES_USER_VOICE_FSET,
                  DEFAULT_FORMAT_NAMES_USER_VOICE_FSET);
  ...
  fset_string_var(FORMAT_NICKNAME_OTHER_FSET,
                  DEFAULT_FORMAT_NICKNAME_OTHER_FSET);
  ...
  fset_string_var(FORMAT_NOTIFY_SIGNOFF_FSET,
                  DEFAULT_FORMAT_NOTIFY_SIGNOFF_FSET);
  ...
  fset_string_var(FORMAT_PUBLIC_NOTICE_AR_FSET,
                  DEFAULT_FORMAT_PUBLIC_NOTICE_AR_FSET);
  fset_string_var(FORMAT_PUBLIC_OTHER_FSET, DEFAULT_FORMAT_PUBLIC_OTHER_FSET);
  fset_string_var(FORMAT_PUBLIC_OTHER_AR_FSET,
                  DEFAULT_FORMAT_PUBLIC_OTHER_AR_FSET);
  fset_string_var(FORMAT_SEND_ACTION_FSET, DEFAULT_FORMAT_SEND_ACTION_FSET);
  fset_string_var(FORMAT_SEND_ACTION_OTHER_FSET,
                  DEFAULT_FORMAT_SEND_ACTION_OTHER_FSET);
  ...
  fset_string_var(FORMAT_SEND_ENCRYPTED_MSG_FSET,
                  DEFAULT_FORMAT_SEND_ENCRYPTED_MSG_FSET);
  fset_string_var(FORMAT_SEND_ENCRYPTED_NOTICE_FSET,
                  DEFAULT_FORMAT_SEND_ENCRYPTED_NOTICE_FSET);
  fset_string_var(FORMAT_SEND_ENCRYPTED_PUBLIC_FSET,
                  DEFAULT_FORMAT_SEND_ENCRYPTED_PUBLIC_FSET);
  ...
  fset_string_var(FORMAT_SEND_PUBLIC_OTHER_FSET,
                  DEFAULT_FORMAT_SEND_PUBLIC_OTHER_FSET);
  ...
  fset_string_var(FORMAT_SERVER_MSG1_FROM_FSET,
                  DEFAULT_FORMAT_SERVER_MSG1_FROM_FSET);
  fset_string_var(FORMAT_SERVER_MSG2_FSET, DEFAULT_FORMAT_SERVER_MSG2_FSET);
  fset_string_var(FORMAT_SERVER_MSG2_FROM_FSET,
                  DEFAULT_FORMAT_SERVER_MSG2_FROM_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_FSET, DEFAULT_FORMAT_SERVER_NOTICE_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_BOT_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_BOT_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_BOT1_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_BOT1_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_BOT_ALARM_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_BOT_ALARM_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_CLIENT_CONNECT_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_CONNECT_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_CLIENT_EXIT_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_EXIT_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_CLIENT_INVALID_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_INVALID_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_CLIENT_TERM_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_CLIENT_TERM_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_FAKE_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_FAKE_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_KILL_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_KILL_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_KILL_LOCAL_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_KILL_LOCAL_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_KLINE_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_KLINE_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_GLINE_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_GLINE_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_NICK_COLLISION_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_NICK_COLLISION_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_OPER_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_OPER_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_REHASH_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_REHASH_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_STATS_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_STATS_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_TRAFFIC_HIGH_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_TRAFFIC_HIGH_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_TRAFFIC_NORM_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_TRAFFIC_NORM_FSET);
  fset_string_var(FORMAT_SERVER_NOTICE_UNAUTH_FSET,
                  DEFAULT_FORMAT_SERVER_NOTICE_UNAUTH_FSET);
  ...
  fset_string_var(FORMAT_SHITLIST_FOOTER_FSET,
                  DEFAULT_FORMAT_SHITLIST_FOOTER_FSET);
  fset_string_var(FORMAT_SHITLIST_HEADER_FSET,
                  DEFAULT_FORMAT_SHITLIST_HEADER_FSET);
  ...
  fset_string_var(FORMAT_USERMODE_OTHER_FSET,
                  DEFAULT_FORMAT_USERMODE_OTHER_FSET);
  fset_string_var(FORMAT_USERLIST_FSET, DEFAULT_FORMAT_USERLIST_FSET);
  fset_string_var(FORMAT_USERLIST_FOOTER_FSET,
                  DEFAULT_FORMAT_USERLIST_FOOTER_FSET);
  fset_string_var(FORMAT_USERLIST_HEADER_FSET,
                  DEFAULT_FORMAT_USERLIST_HEADER_FSET);
  ...
  fset_string_var(FORMAT_WHOIS_ACTUALLY_FSET,
                  DEFAULT_FORMAT_WHOIS_ACTUALLY_FSET);
  ...
  fset_string_var(FORMAT_WHOIS_CALLERID_FSET,
                  DEFAULT_FORMAT_WHOIS_CALLERID_FSET);
  fset_string_var(FORMAT_WHOIS_CHANNELS_FSET,
  ...
  fset_string_var(FORMAT_WHOIS_LOGGEDIN_FSET,
                  DEFAULT_FORMAT_WHOIS_LOGGEDIN_FSET);
  ...
  fset_string_var(FORMAT_WHOLEFT_HEADER_FSET,
                  DEFAULT_FORMAT_WHOLEFT_HEADER_FSET);
  ...
  fset_string_var(FORMAT_WHOIS_REGISTER_FSET,
                  DEFAULT_FORMAT_WHOIS_REGISTER_FSET);
...
int save_formats(void) {
  ...
  snprintf(thefile, sizeof thefile, "%s/%s.fmt", get_string_var(CTOOLZ_DIR_VAR),
           version);
#else
  snprintf(thefile, sizeof thefile, "%s/%s.formats",
           get_string_var(CTOOLZ_DIR_VAR), version);
#endif
...
IrcVariable *fget_var_address(char *var_name) {
  ...
  if ((var = find_ext_fset_var(tmp_var)))
    return var;
  if ((find_fixed_array_item(fset_array, sizeof(IrcVariable), NUMBER_OF_FSET,
                             tmp_var, &cnt, &msv_index) == NULL))
    return NULL;
  if (cnt >= 0)
    return NULL;
...
#ifdef WANT_TCL
char *fset_rem_str(ClientData *cd, Tcl_Interp *intp, char *name1, char *name2,
                   int flags) {
  char *s;
  IrcVariable *n;
  n = (IrcVariable *)cd;
...
#ifdef GUI
IrcVariable *return_fset_var(int nummer) { return &fset_array[nummer]; }
#endif
