...
static IrcVariable irc_variable[] = {
    {"AINV", 0, INT_TYPE_VAR, DEFAULT_AINV, NULL, NULL, 0, VF_BITCHX},
    {"ALTNICK", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"ALT_CHARSET", 0, BOOL_TYPE_VAR, DEFAULT_ALT_CHARSET, NULL, NULL, 0,
     VF_BITCHX},
    {"ALWAYS_SPLIT_BIGGEST", 0, BOOL_TYPE_VAR, DEFAULT_ALWAYS_SPLIT_BIGGEST,
     NULL, NULL, 0, 0},
    {"ANNOY_KICK", 0, BOOL_TYPE_VAR, DEFAULT_ANNOY_KICK, NULL, NULL, 0,
     VF_BITCHX},
    {"AOP", 0, BOOL_TYPE_VAR, DEFAULT_AOP_VAR, NULL, NULL, 0, VF_BITCHX},
    {"APPEND_LOG", 0, BOOL_TYPE_VAR, 1, NULL, NULL, 0, VF_BITCHX},

    {"AUTOKICK_ON_VERSION", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"AUTO_AWAY", 0, BOOL_TYPE_VAR, DEFAULT_AUTO_AWAY, NULL, NULL, 0,
     VF_BITCHX},
    {"AUTO_AWAY_TIME", 0, INT_TYPE_VAR, DEFAULT_AUTO_AWAY_TIME, NULL,
     set_away_time, 0, VF_BITCHX},
    {"AUTO_JOIN_ON_INVITE", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"AUTO_LIMIT", 0, INT_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"AUTO_NSLOOKUP", 0, BOOL_TYPE_VAR, DEFAULT_AUTO_NSLOOKUP, NULL, NULL, 0,
     VF_BITCHX},
    {"AUTO_RECONNECT", 0, BOOL_TYPE_VAR, DEFAULT_AUTO_RECONNECT, NULL, NULL, 0,
     VF_BITCHX},
    {"AUTO_REJOIN", 0, INT_TYPE_VAR, DEFAULT_AUTO_REJOIN, NULL, NULL, 0,
     VF_BITCHX},
    {"AUTO_RESPONSE", 0, BOOL_TYPE_VAR, 1, NULL, NULL, 0, VF_BITCHX},
    {"AUTO_RESPONSE_STR", 0, STR_TYPE_VAR, 0, NULL, reinit_autoresponse, 0,
     VF_BITCHX},
    {"AUTO_UNBAN", 0, INT_TYPE_VAR, DEFAULT_AUTO_UNBAN, NULL, NULL, 0,
     VF_BITCHX},
    {"AUTO_UNMARK_AWAY", 0, BOOL_TYPE_VAR, DEFAULT_AUTO_UNMARK_AWAY, NULL, NULL,
     0, 0},
    {"AUTO_WHOWAS", 0, BOOL_TYPE_VAR, DEFAULT_AUTO_WHOWAS, NULL, NULL, 0, 0},
    {"BANTIME", 0, INT_TYPE_VAR, DEFAULT_BANTIME, NULL, NULL, 0, VF_BITCHX},
    {"BEEP", 0, BOOL_TYPE_VAR, DEFAULT_BEEP, NULL, NULL, 0, VF_BITCHX},
    {"BEEP_ALWAYS", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"BEEP_MAX", 0, INT_TYPE_VAR, DEFAULT_BEEP_MAX, NULL, NULL, 0, 0},
    {"BEEP_ON_MSG", 0, STR_TYPE_VAR, 0, NULL, set_beep_on_msg, 0, VF_BITCHX},
    {"BEEP_WHEN_AWAY", 0, INT_TYPE_VAR, DEFAULT_BEEP_WHEN_AWAY, NULL, NULL, 0,
     VF_BITCHX},
    {"BITCH", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"BITCHX_HELP", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"BLINK_VIDEO", 0, BOOL_TYPE_VAR, DEFAULT_BLINK_VIDEO, NULL, NULL, 0, 0},
    {"BOLD_VIDEO", 0, BOOL_TYPE_VAR, DEFAULT_BOLD_VIDEO, NULL, NULL, 0, 0},
    {"BOT_LOG", 0, BOOL_TYPE_VAR, 1, NULL, NULL, 0, VF_BITCHX},
    {"BOT_LOGFILE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    ...
    {"CDCC_FLOOD_AFTER", 0, INT_TYPE_VAR, DEFAULT_CDCC_FLOOD_AFTER, NULL, NULL,
     0, VF_BITCHX},
    {"CDCC_FLOOD_RATE", 0, INT_TYPE_VAR, DEFAULT_CDCC_FLOOD_RATE, NULL, NULL, 0,
     VF_BITCHX},
    {"CDCC_PROMPT", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"CDCC_SECURITY", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
#ifdef WANT_CD
    {"CD_DEVICE", 0, STR_TYPE_VAR, 0, NULL, set_cd_device, 0, VF_BITCHX},
#else
    {"CD_DEVICE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
#endif
    {"CHANGE_NICK_ON_KILL", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"CHANMODE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"CHANNEL_NAME_WIDTH", 0, INT_TYPE_VAR, DEFAULT_CHANNEL_NAME_WIDTH, NULL,
     BX_update_all_status, 0, 0},
    {"CHECK_BEEP_USERS", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"CLIENT_INFORMATION", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_NO_SAVE},
    {"CLOAK", 0, INT_TYPE_VAR, DEFAULT_CLOAK, NULL, BX_update_all_status, 0,
     VF_BITCHX},
    {"CLOCK", 0, BOOL_TYPE_VAR, DEFAULT_CLOCK, NULL, BX_update_all_status, 0,
     0},
    {"CLOCK_24HOUR", 0, BOOL_TYPE_VAR, DEFAULT_CLOCK_24HOUR, NULL, reset_clock,
     0, VF_BITCHX},
    ...
    {"CONNECT_DELAY", 0, INT_TYPE_VAR, DEFAULT_CONNECT_DELAY, NULL, NULL, 0,
     VF_BITCHX},
    {"CONNECT_TIMEOUT", 0, INT_TYPE_VAR, DEFAULT_CONNECT_TIMEOUT, NULL, NULL, 0,
     0},
    {"CONTINUED_LINE", 0, STR_TYPE_VAR, 0, NULL, BX_set_continued_lines, 0, 0},
    {"CPU_SAVER_AFTER", 0, INT_TYPE_VAR, DEFAULT_CPU_SAVER_AFTER, NULL, NULL, 0,
     VF_BITCHX},
    {"CPU_SAVER_EVERY", 0, INT_TYPE_VAR, DEFAULT_CPU_SAVER_EVERY, NULL, NULL, 0,
     VF_BITCHX},
    {"CTCP_DELAY", 0, INT_TYPE_VAR, DEFAULT_CTCP_DELAY, NULL, NULL, 0,
     VF_BITCHX},
    {"CTCP_FLOOD_AFTER", 0, INT_TYPE_VAR, DEFAULT_CTCP_FLOOD_AFTER, NULL, NULL,
     0, VF_BITCHX},
    {"CTCP_FLOOD_BAN", 0, BOOL_TYPE_VAR, DEFAULT_CTCP_FLOOD_BAN, NULL, NULL, 0,
     0},
    {"CTCP_FLOOD_PROTECTION", 0, BOOL_TYPE_VAR, DEFAULT_CTCP_FLOOD_PROTECTION,
     NULL, NULL, 0, 0},
    {"CTCP_FLOOD_RATE", 0, INT_TYPE_VAR, DEFAULT_CTCP_FLOOD_RATE, NULL, NULL, 0,
     VF_BITCHX},
    {"CTCP_VERBOSE", 0, BOOL_TYPE_VAR, DEFAULT_VERBOSE_CTCP, NULL, NULL, 0, 0},
    {"CTOOLZ_DIR", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DCC_AUTOGET", 0, BOOL_TYPE_VAR, DEFAULT_DCC_AUTOGET, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_AUTORENAME", 0, BOOL_TYPE_VAR, DEFAULT_DCC_AUTORENAME, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_AUTORESUME", 0, BOOL_TYPE_VAR, DEFAULT_DCC_AUTORESUME, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_BAR_TYPE", 0, INT_TYPE_VAR, DEFAULT_DCC_BAR_TYPE, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_BLOCK_SIZE", 0, INT_TYPE_VAR, DEFAULT_DCC_BLOCK_SIZE, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_DLDIR", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DCC_FAST", 0, BOOL_TYPE_VAR, DEFAULT_DCC_FAST, NULL, NULL, 0, VF_BITCHX},
    {"DCC_FORCE_PORT", 0, INT_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DCC_GET_LIMIT", 0, INT_TYPE_VAR, DEFAULT_DCC_GET_LIMIT, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_MAX_AUTOGET_SIZE", 0, INT_TYPE_VAR, DEFAULT_MAX_AUTOGET_SIZE, NULL,
     NULL, 0, VF_BITCHX},
    {"DCC_QUEUE_LIMIT", 0, INT_TYPE_VAR, DEFAULT_DCC_QUEUE_LIMIT, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_SEND_LIMIT", 0, INT_TYPE_VAR, DEFAULT_DCC_SEND_LIMIT, NULL, NULL, 0,
     VF_BITCHX},
    {"DCC_TIMEOUT", 0, INT_TYPE_VAR, DEFAULT_DCCTIMEOUT, NULL, set_dcc_timeout,
     0, VF_BITCHX},
    {"DCC_ULDIR", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DCC_USE_GATEWAY_ADDR", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DEBUG", 0, STR_TYPE_VAR, 0, NULL, debug_window, 0, 0},
#if defined(__EMXPM__) || defined(WIN32)
    {"DEFAULT_CODEPAGE", 0, INT_TYPE_VAR, DEFAULT_CODEPAGE, NULL, NULL, 0,
     VF_BITCHX},
#endif
    {"DEFAULT_FONT", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DEFAULT_MENU", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"DEFAULT_NICK", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DEFAULT_REASON", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"DEOPFLOOD", 0, BOOL_TYPE_VAR, DEFAULT_DEOPFLOOD, NULL, NULL, 0,
     VF_BITCHX},
    {"DEOPFLOOD_TIME", 0, INT_TYPE_VAR, DEFAULT_DEOPFLOOD_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"DEOP_ON_DEOPFLOOD", 0, INT_TYPE_VAR, DEFAULT_DEOP_ON_DEOPFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"DEOP_ON_KICKFLOOD", 0, INT_TYPE_VAR, DEFAULT_DEOP_ON_KICKFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"DETACH_ON_HUP", 0, BOOL_TYPE_VAR, DEFAULT_DETACH_ON_HUP, NULL,
     set_detach_on_hup, 0, 0},
    {"DISPATCH_UNKNOWN_COMMANDS", 0, BOOL_TYPE_VAR,
     DEFAULT_DISPATCH_UNKNOWN_COMMANDS, NULL, NULL, 0, 0},
    {"DISPLAY", 0, BOOL_TYPE_VAR, DEFAULT_DISPLAY, NULL, NULL, 0, VF_NO_SAVE},
    {"DISPLAY_ANSI", 0, BOOL_TYPE_VAR, DEFAULT_DISPLAY_ANSI, NULL,
     toggle_reverse_status, 0, 0},
    {"DISPLAY_PC_CHARACTERS", 0, INT_TYPE_VAR, DEFAULT_DISPLAY_PC_CHARACTERS,
     NULL, reinit_screen, 0, VF_BITCHX},
    {"DOUBLE_STATUS_LINE", 0, INT_TYPE_VAR, DEFAULT_DOUBLE_STATUS_LINE, NULL,
     NULL, 0, VF_BITCHX},
    {"EIGHT_BIT_CHARACTERS", 0, BOOL_TYPE_VAR, DEFAULT_EIGHT_BIT_CHARACTERS,
     NULL, eight_bit_characters, 0, VF_BITCHX},
    {"EXEC_PROTECTION", 0, BOOL_TYPE_VAR, DEFAULT_EXEC_PROTECTION, NULL,
     exec_warning, 0, 0},
    {"FAKE_SPLIT_PATTERNS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},

    {"FLOATING_POINT_MATH_VAR", 0, BOOL_TYPE_VAR, DEFAULT_FLOATING_POINT_MATH,
     NULL, NULL, 0, 0},
    {"FLOOD_AFTER", 0, INT_TYPE_VAR, DEFAULT_FLOOD_AFTER, NULL, NULL, 0,
     VF_BITCHX},
    {"FLOOD_KICK", 0, BOOL_TYPE_VAR, DEFAULT_FLOOD_KICK, NULL, NULL, 0,
     VF_BITCHX},
    {"FLOOD_PROTECTION", 0, BOOL_TYPE_VAR, DEFAULT_FLOOD_PROTECTION, NULL, NULL,
     0, VF_BITCHX},
    {"FLOOD_RATE", 0, INT_TYPE_VAR, DEFAULT_FLOOD_RATE, NULL, NULL, 0,
     VF_BITCHX},
    {"FLOOD_USERS", 0, INT_TYPE_VAR, DEFAULT_FLOOD_USERS, NULL, NULL, 0,
     VF_BITCHX},
    {"FLOOD_WARNING", 0, BOOL_TYPE_VAR, DEFAULT_FLOOD_WARNING, NULL, NULL, 0,
     VF_BITCHX},

    {"FTP_GRAB", 0, BOOL_TYPE_VAR, DEFAULT_FTP_GRAB, NULL, NULL, 0, VF_BITCHX},
    {"FULL_STATUS_LINE", 0, BOOL_TYPE_VAR, DEFAULT_FULL_STATUS_LINE, NULL,
     BX_update_all_status, 0, 0},
    {"HACKING", 0, INT_TYPE_VAR, DEFAULT_HACKING, NULL, NULL, 0, VF_BITCHX},
    {"HACK_OPS", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"HEBREW_TOGGLE", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"HELP_PAGER", 0, BOOL_TYPE_VAR, DEFAULT_HELP_PAGER, NULL, NULL, 0, 0},
    {"HELP_PATH", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_EXPAND_PATH},
    ...
    {"HIDE_PRIVATE_CHANNELS", 0, BOOL_TYPE_VAR, DEFAULT_HIDE_PRIVATE_CHANNELS,
     NULL, BX_update_all_status, 0, 0},
    {"HIGHLIGHT_CHAR", 0, STR_TYPE_VAR, 0, NULL, set_highlight_char, 0, 0},
    {"HIGH_BIT_ESCAPE", 0, INT_TYPE_VAR, DEFAULT_HIGH_BIT_ESCAPE, NULL,
     set_meta_8bit, 0, 0},
    {"HISTORY", 0, INT_TYPE_VAR, DEFAULT_HISTORY, NULL, set_history_size, 0, 0},
    {"HOLD_MODE", 0, BOOL_TYPE_VAR, DEFAULT_HOLD_MODE, NULL, BX_reset_line_cnt,
     0, 0},
    {"HOLD_MODE_MAX", 0, INT_TYPE_VAR, DEFAULT_HOLD_MODE_MAX, NULL, NULL, 0, 0},
    {"HTTP_GRAB", 0, BOOL_TYPE_VAR, DEFAULT_HTTP_GRAB, NULL, NULL, 0,
     VF_BITCHX},
    {"IDENT_HACK", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"IDLE_CHECK", 0, INT_TYPE_VAR, 120, NULL, NULL, 0, VF_BITCHX},
    {"IGNORE_TIME", 0, INT_TYPE_VAR, DEFAULT_IGNORE_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"INDENT", 0, BOOL_TYPE_VAR, DEFAULT_INDENT, NULL, NULL, 0, 0},
    {"INPUT_ALIASES", 0, BOOL_TYPE_VAR, DEFAULT_INPUT_ALIASES, NULL, NULL, 0,
     0},
    {"INPUT_GLOB", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"INPUT_PROMPT", 0, STR_TYPE_VAR, 0, NULL, BX_set_input_prompt, 0, 0},
    {"INSERT_MODE", 0, BOOL_TYPE_VAR, DEFAULT_INSERT_MODE, NULL,
     BX_update_all_status, 0, 0},
    {"INVERSE_VIDEO", 0, BOOL_TYPE_VAR, DEFAULT_INVERSE_VIDEO, NULL, NULL, 0,
     0},
    {"JOINFLOOD", 0, BOOL_TYPE_VAR, DEFAULT_JOINFLOOD, NULL, NULL, 0,
     VF_BITCHX},
    {"JOINFLOOD_TIME", 0, INT_TYPE_VAR, DEFAULT_JOINFLOOD_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"JOIN_NEW_WINDOW", 0, BOOL_TYPE_VAR, DEFAULT_JOIN_NEW_WINDOW, NULL, NULL,
     0, VF_BITCHX},
    {"JOIN_NEW_WINDOW_TYPE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"KICKFLOOD", 0, BOOL_TYPE_VAR, DEFAULT_KICKFLOOD, NULL, NULL, 0,
     VF_BITCHX},
    {"KICKFLOOD_TIME", 0, INT_TYPE_VAR, DEFAULT_KICKFLOOD_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"KICK_IF_BANNED", 0, BOOL_TYPE_VAR, DEFAULT_KICK_IF_BANNED, NULL, NULL, 0,
     VF_BITCHX},
    {"KICK_ON_DEOPFLOOD", 0, INT_TYPE_VAR, DEFAULT_KICK_ON_DEOPFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"KICK_ON_JOINFLOOD", 0, INT_TYPE_VAR, DEFAULT_KICK_ON_JOINFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"KICK_ON_KICKFLOOD", 0, INT_TYPE_VAR, DEFAULT_KICK_ON_KICKFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"KICK_ON_NICKFLOOD", 0, INT_TYPE_VAR, DEFAULT_KICK_ON_NICKFLOOD, NULL,
     NULL, 0, VF_BITCHX},
    {"KICK_ON_PUBFLOOD", 0, INT_TYPE_VAR, DEFAULT_KICK_ON_PUBFLOOD, NULL, NULL,
     0, VF_BITCHX},
    {"KICK_OPS", 0, BOOL_TYPE_VAR, DEFAULT_KICK_OPS, NULL, NULL, 0, VF_BITCHX},
    {"LAG_CHECK_INTERVAL", 0, INT_TYPE_VAR, DEFAULT_LAG_CHECK_INTERVAL, NULL,
     NULL, 0, VF_BITCHX},
    {"LAMEIDENT", 0, BOOL_TYPE_VAR, DEFAULT_LAME_IDENT, NULL, NULL, 0,
     VF_BITCHX},
    {"LAMELIST", 0, BOOL_TYPE_VAR, DEFAULT_LAMELIST, NULL, NULL, 0, VF_BITCHX},
    {"LASTLOG", 0, INT_TYPE_VAR, DEFAULT_LASTLOG, NULL, set_lastlog_size, 0, 0},
    {"LASTLOG_ANSI", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"LASTLOG_LEVEL", 0, STR_TYPE_VAR, 0, NULL, set_lastlog_level, 0, 0},
    {"LLOOK", 0, BOOL_TYPE_VAR, DEFAULT_LLOOK, NULL, NULL, 0, 0},
    {"LLOOK_DELAY", 0, INT_TYPE_VAR, DEFAULT_LLOOK_DELAY, NULL, NULL, 0,
     VF_BITCHX},
    {"LOAD_PATH", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"LOG", 0, BOOL_TYPE_VAR, DEFAULT_LOG, NULL, logger, 0, 0},
    {"LOGFILE", 0, STR_TYPE_VAR, 0, NULL, set_log_file, 0, 0},
    {"MAIL", 0, INT_TYPE_VAR, DEFAULT_MAIL, NULL, BX_update_all_status, 0,
     VF_BITCHX},

    {"MANGLE_INBOUND", 0, STR_TYPE_VAR, 0, NULL, set_mangle_inbound, 0,
     VF_BITCHX},
    {"MANGLE_LOGFILES", 0, STR_TYPE_VAR, 0, NULL, set_mangle_logfiles, 0,
     VF_BITCHX},
    {"MANGLE_OPERLOG", 0, STR_TYPE_VAR, 0, NULL, set_mangle_operlog, 0,
     VF_BITCHX},
    {"MANGLE_OUTBOUND", 0, STR_TYPE_VAR, 0, NULL, set_mangle_outbound, 0,
     VF_BITCHX},

    {"MAX_DEOPS", 0, INT_TYPE_VAR, DEFAULT_MAX_DEOPS, NULL, NULL, 0, VF_BITCHX},
    {"MAX_IDLEKICKS", 0, INT_TYPE_VAR, DEFAULT_MAX_IDLEKICKS, NULL, NULL, 0,
     VF_BITCHX},
    {"MAX_SERVER_RECONNECT", 0, INT_TYPE_VAR, DEFAULT_MAX_SERVER_RECONNECT,
     NULL, NULL, 0, VF_BITCHX},
    {"MAX_URLS", 0, INT_TYPE_VAR, DEFAULT_MAX_URLS, NULL, NULL, 0, VF_BITCHX},
#ifdef GUI
    {"MDI", 0, BOOL_TYPE_VAR, DEFAULT_MDI, NULL, gui_mdi, 0, VF_BITCHX},
#else
    {"MDI", 0, BOOL_TYPE_VAR, DEFAULT_MDI, NULL, NULL, 0, VF_BITCHX},
#endif
    {"META_STATES_VAR", 0, INT_TYPE_VAR, DEFAULT_META_STATES, NULL, NULL, 0, 0},
    {"MIRCS", 0, BOOL_TYPE_VAR, 1, NULL, NULL, 0, VF_BITCHX},
    ...
    {"MSGLOG_FILE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0,
     VF_BITCHX | VF_EXPAND_PATH},
    {"MSGLOG_LEVEL", 0, STR_TYPE_VAR, 0, NULL, set_msglog_level, 0, VF_BITCHX},
    {"NAMES_COLUMNS", 0, INT_TYPE_VAR, 5, NULL, NULL, 0, VF_BITCHX},
    {"NAT_ADDRESS", 0, STR_TYPE_VAR, 0, NULL, set_nat_address, 0, VF_BITCHX},
    {"ND_SPACE_MAX", 0, INT_TYPE_VAR, DEFAULT_ND_SPACE_MAX, NULL, NULL, 0, 0},
    {"NEW_SERVER_LASTLOG_LEVEL", 0, STR_TYPE_VAR, 0, NULL,
     set_new_server_lastlog_level, 0, VF_BITCHX},
    {"NEXT_SERVER_ON_LOCAL_KILL", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0,
     VF_BITCHX},

    {"NICKFLOOD", 0, BOOL_TYPE_VAR, DEFAULT_NICKFLOOD, NULL, NULL, 0,
     VF_BITCHX},
    {"NICKFLOOD_TIME", 0, INT_TYPE_VAR, DEFAULT_NICKFLOOD_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"NICKLIST", 0, INT_TYPE_VAR, DEFAULT_NICKLIST, NULL, NULL, 0, VF_BITCHX},
    {"NICKLIST_SORT", 0, INT_TYPE_VAR, DEFAULT_NICKLIST_SORT, NULL, NULL, 0,
     VF_BITCHX},
    {"NICK_COMPLETION", 0, BOOL_TYPE_VAR, DEFAULT_NICK_COMPLETION, NULL, NULL,
     0, VF_BITCHX},
    {"NICK_COMPLETION_CHAR", 0, CHAR_TYPE_VAR, DEFAULT_NICK_COMPLETION_CHAR,
     NULL, NULL, 0, VF_BITCHX},
    {"NICK_COMPLETION_LEN", 0, INT_TYPE_VAR, DEFAULT_NICK_COMPLETION_LEN, NULL,
     NULL, 0, VF_BITCHX},
    {"NICK_COMPLETION_TYPE", 0, INT_TYPE_VAR, DEFAULT_NICK_COMPLETION_TYPE,
     NULL, NULL, 0, VF_BITCHX},
    {"NOTIFY", 0, BOOL_TYPE_VAR, DEFAULT_NOTIFY, NULL, NULL, 0, VF_BITCHX},
    {"NOTIFY_HANDLER", 0, STR_TYPE_VAR, 0, NULL, set_notify_handler, 0, 0},
    {"NOTIFY_INTERVAL", 0, INT_TYPE_VAR, DEFAULT_NOTIFY_INTERVAL, NULL, NULL, 0,
     VF_BITCHX},
    {"NOTIFY_LEVEL", 0, STR_TYPE_VAR, 0, NULL, set_notify_level, 0, 0},
    {"NOTIFY_ON_TERMINATION", 0, BOOL_TYPE_VAR, DEFAULT_NOTIFY_ON_TERMINATION,
     NULL, NULL, 0, 0},
    {"NO_CTCP_FLOOD", 0, BOOL_TYPE_VAR, DEFAULT_NO_CTCP_FLOOD, NULL, NULL, 0,
     0},
    {"NO_FAIL_DISCONNECT", 0, BOOL_TYPE_VAR, DEFAULT_NO_FAIL_DISCONNECT, NULL,
     NULL, 0, VF_BITCHX},
    {"NUM_BANMODES", 0, INT_TYPE_VAR, DEFAULT_NUM_BANMODES, NULL, NULL, 0,
     VF_BITCHX},
    {"NUM_KICKS", 0, INT_TYPE_VAR, DEFAULT_NUM_KICKS, NULL, NULL, 0, VF_BITCHX},
    {"NUM_KILLS", 0, INT_TYPE_VAR, 1, NULL, NULL, 0, VF_BITCHX},
    {"NUM_OF_WHOWAS", 0, INT_TYPE_VAR, DEFAULT_NUM_OF_WHOWAS, NULL, NULL, 0,
     VF_BITCHX},
    {"NUM_OPMODES", 0, INT_TYPE_VAR, DEFAULT_NUM_OPMODES, NULL, NULL, 0,
     VF_BITCHX},
    {"OPER_MODES", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"ORIGNICK_TIME", 0, INT_TYPE_VAR, 5, NULL, NULL, 0, VF_BITCHX},
#ifdef WANT_OPERVIEW
    {"OV", 0, BOOL_TYPE_VAR, DEFAULT_OPER_VIEW, NULL, set_ov_mode, 0,
     VF_BITCHX},
#else
    {"OV", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
#endif
    {"PAD_CHAR", 0, CHAR_TYPE_VAR, DEFAULT_PAD_CHAR, NULL, NULL, 0, 0},
    {"PING_TYPE", 0, INT_TYPE_VAR, DEFAULT_PING_TYPE, NULL, NULL, 0, VF_BITCHX},
    {"PROTECT_CHANNELS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"PUBFLOOD", 0, BOOL_TYPE_VAR, DEFAULT_PUBFLOOD, NULL, NULL, 0, VF_BITCHX},
    {"PUBFLOOD_TIME", 0, INT_TYPE_VAR, DEFAULT_PUBFLOOD_TIME, NULL, NULL, 0,
     VF_BITCHX},
    {"QUERY_NEW_WINDOW", 0, BOOL_TYPE_VAR, DEFAULT_QUERY_NEW_WINDOW, NULL, NULL,
     0, VF_BITCHX},
    {"QUERY_NEW_WINDOW_TYPE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"QUEUE_SENDS", 0, INT_TYPE_VAR, DEFAULT_QUEUE_SENDS, NULL, NULL, 0,
     VF_BITCHX},
    {"RANDOM_LOCAL_PORTS", 0, BOOL_TYPE_VAR, DEFAULT_RANDOM_LOCAL_PORTS, NULL,
     NULL, 0, VF_BITCHX},
    {"RANDOM_SOURCE", 0, INT_TYPE_VAR, DEFAULT_RANDOM_SOURCE, NULL, NULL, 0,
     VF_BITCHX},
    {"REALNAME", 0, STR_TYPE_VAR, 0, NULL, set_realname, 0, 0},
    {"REVERSE_STATUS", 0, BOOL_TYPE_VAR, 0, NULL, reinit_status, 0, 0},
    {"SAVEFILE", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"SCREEN_OPTIONS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"SCRIPT_HELP", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"SCROLLBACK", 0, INT_TYPE_VAR, DEFAULT_SCROLLBACK_LINES, NULL,
     BX_set_scrollback_size, 0, 0},
    {"SCROLLBACK_RATIO", 0, INT_TYPE_VAR, DEFAULT_SCROLLBACK_RATIO, NULL, NULL,
     0, 0},
    {"SCROLL_LINES", 0, INT_TYPE_VAR, DEFAULT_SCROLL_LINES, NULL,
     BX_set_scroll_lines, 0, 0},
    {"SEND_AWAY_MSG", 0, BOOL_TYPE_VAR, DEFAULT_SEND_AWAY_MSG, NULL, NULL, 0,
     VF_BITCHX},
    {"SEND_CTCP_MSG", 0, BOOL_TYPE_VAR, DEFAULT_SEND_CTCP_MSG, NULL, NULL, 0,
     VF_BITCHX},
    {"SEND_IGNORE_MSG", 0, BOOL_TYPE_VAR, DEFAULT_SEND_IGNORE_MSG, NULL, NULL,
     0, VF_BITCHX},
    {"SEND_OP_MSG", 0, BOOL_TYPE_VAR, DEFAULT_SEND_OP_MSG, NULL, NULL, 0,
     VF_BITCHX},
    {"SERVER_GROUPS", 0, BOOL_TYPE_VAR, DEFAULT_SERVER_GROUPS, NULL, NULL, 0,
     VF_BITCHX},
    {"SERVER_PROMPT", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"SHELL", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"SHELL_FLAGS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"SHELL_LIMIT", 0, INT_TYPE_VAR, DEFAULT_SHELL_LIMIT, NULL, NULL, 0, 0},
    {"SHITLIST", 0, BOOL_TYPE_VAR, DEFAULT_SHITLIST, NULL, NULL, 0, VF_BITCHX},
    {"SHITLIST_REASON", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"SHOW_AWAY_ONCE", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_AWAY_ONCE, NULL, NULL, 0,
     VF_BITCHX},
    {"SHOW_CHANNEL_NAMES", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_CHANNEL_NAMES, NULL,
     NULL, 0, 0},
    {"SHOW_END_OF_MSGS", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_END_OF_MSGS, NULL, NULL,
     0, 0},
    {"SHOW_NUMERICS", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_NUMERICS, NULL, NULL, 0,
     0},
    {"SHOW_NUMERICS_STR", 0, STR_TYPE_VAR, 0, NULL, set_numeric_string, 0, 0},
    {"SHOW_STATUS_ALL", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_STATUS_ALL, NULL,
     BX_update_all_status, 0, 0},
    {"SHOW_WHO_HOPCOUNT", 0, BOOL_TYPE_VAR, DEFAULT_SHOW_WHO_HOPCOUNT, NULL,
     NULL, 0, 0},
    {"SOCKS_HOST", 0, STR_TYPE_VAR, 0, NULL, set_use_socks, 0, VF_BITCHX},
    {"SOCKS_PORT", 0, INT_TYPE_VAR, DEFAULT_SOCKS_PORT, NULL, NULL, 0,
     VF_BITCHX},
    ...
    {"STATUS_DOES_EXPANDOS", 0, BOOL_TYPE_VAR, DEFAULT_STATUS_DOES_EXPANDOS,
     NULL, BX_build_status, 0, 0},
    ...
    {"STATUS_MAIL", 0, STR_TYPE_VAR, 0, NULL, BX_build_status, 0, 0},
    ...
    {"STATUS_NO_REPEAT", 0, BOOL_TYPE_VAR, DEFAULT_STATUS_NO_REPEAT, NULL, NULL,
     0, 0},
    ...
    {"SUPPRESS_SERVER_MOTD", 0, BOOL_TYPE_VAR, DEFAULT_SUPPRESS_SERVER_MOTD,
     NULL, NULL, 0, 0},
#ifdef WANT_OPERVIEW
    {"SWATCH", 0, STR_TYPE_VAR, 0, NULL, convert_swatch, 0, VF_BITCHX},
#else
    ...
    {"TIMESTAMP", 0, BOOL_TYPE_VAR, DEFAULT_TIMESTAMP, NULL, NULL, 0,
     VF_BITCHX},
    {"TIMESTAMP_AWAYLOG_HOURLY", 0, BOOL_TYPE_VAR,
     DEFAULT_TIMESTAMP_AWAYLOG_HOURLY, NULL, NULL, 0, VF_BITCHX},
    {"TIMESTAMP_STRING", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    ...
    {"UNDERLINE_VIDEO", 0, BOOL_TYPE_VAR, DEFAULT_UNDERLINE_VIDEO, NULL, NULL,
     0, 0},
    {"USERLIST", 0, BOOL_TYPE_VAR, DEFAULT_USERLIST, NULL, NULL, 0, VF_BITCHX},
    {"USERMODE", 0, STR_TYPE_VAR, 0, NULL, set_user_mode, 0, VF_BITCHX},
    {"USER_FLAG_OPS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"USER_FLAG_PROT", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"USER_INFORMATION", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"WINDOW_DESTROY_PART", 0, BOOL_TYPE_VAR, DEFAULT_WINDOW_DESTROY_PART, NULL,
     NULL, 0, VF_BITCHX},
    {"WINDOW_QUIET", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"WORD_BREAK", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"XTERM", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"XTERM_OPTIONS", 0, STR_TYPE_VAR, 0, NULL, NULL, 0, 0},
    {"XTERM_TITLE", 0, BOOL_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
    {"_CDCC_CLOSE_IDLE_SENDS_TIME", 0, INT_TYPE_VAR, 55, NULL, NULL, 0,
     VF_BITCHX},
    {"_CDCC_MINSPEED_TIME", 0, INT_TYPE_VAR, 0, NULL, NULL, 0, VF_BITCHX},
 ...
 * into the variable table.  Does no checking of variable types, etc
 */
int BX_get_int_var(enum VAR_TYPES var) { return (irc_variable[var].integer); }
...
void init_variables() {
  ...
  set_string_var(
      FAKE_SPLIT_PATS_VAR,
      "*fuck* *shit* *suck* *dick* *penis* *cunt* *haha* *fake* *split* *hehe* "
      "*bogus* *yawn* *leet* *blow* *screw* *dumb* *fbi* *l33t* *gov");
  ...
  set_highlight_char(current_window, irc_variable[HIGHLIGHT_CHAR_VAR].string,
                     0);
  ...
  case BOOL_TYPE_VAR:
    if (value && *value && (value = next_arg(value, &rest))) {
      ...
      put_it("%s", convert_output_format(
                       fget_string_var(FORMAT_SET_FSET), "%s %s", var->name,
                       var->integer ? var_settings[ON] : var_settings[OFF]));
    break;
  case CHAR_TYPE_VAR:
    if (!value) {
      ...
      if (strlen(value) > 1)
        say("Value of %s must be a single character", var->name);
      else {
        if (!(var->int_flags & VIF_CHANGED)) {
      ...
      put_it("%s", convert_output_format(fget_string_var(FORMAT_SET_FSET),
                                         "%s %c", var->name, var->integer));
    break;
  case INT_TYPE_VAR:
    if (value && *value && (value = next_arg(value, &rest))) {
      int val;
  ...
  case STR_TYPE_VAR:
    if (value) {
      if (*value) {
        ...
        put_it("%s", convert_output_format(
                         fget_string_var(var->string ? FORMAT_SET_FSET
...
void do_stack_set(int type, char *args) {
  ...
  if (STACK_PUSH == type) {
    ...
    find_fixed_array_item(irc_variable, sizeof(IrcVariable),
                          NUMBER_OF_VARIABLES, copy, &cnt, (int *)&var_index);
    if (cnt < 0 || cnt == 1) {
  ...
  if (STACK_LIST == type) {
    for (aptr = *aptrptr; aptr; aptr = aptr->next) {
      ...
      case CHAR_TYPE_VAR:
        ...
        break;
      case STR_TYPE_VAR:
        say("Variable [%s] = %s", aptr->set->name,
            aptr->set->string ? aptr->set->string : "<Empty String>");
        break;
      default:
...
BUILT_IN_COMMAND(setcmd) {
  ...
  if ((var = next_arg(args, &args)) != NULL) {
    ...
    if (dll_variable) {
      int dll_cnt = 0;
      if ((dll = (IrcVariableDll *)find_in_list_ext((List **)&dll_variable, var,
                                                    0, list_strnicmp))) {
        IrcVariableDll *tmp;
...
#endif
    {
      upper(var);
      find_fixed_array_item(irc_variable, sizeof(IrcVariable),
                            NUMBER_OF_VARIABLES, var, &cnt, (int *)&var_index);
    }

    if (cnt == 1)
      cnt = -1;
    if ((cnt >= 0) ||
        (!dll && !(irc_variable[var_index].int_flags & VIF_PENDING)) ||
        (dll && !(dll->int_flags & VIF_PENDING)))
      hook = 1;
      ...
      if (cnt < 0) {
        ...
        if (do_hook(SET_LIST, "set-error %s is ambiguous", var)) {
          ...
          if (dll) {
            ...
            int i;
            for (i = (int)var_index; i < (int)var_index + cnt; i++)
              set_var_value(i, empty_string);
          }
        }
      }
    }
 ...
 */
static int save_vars_by_flags(FILE *fp, char int_flags_mask, char int_flags,
                              unsigned short flags_mask, unsigned short flags) {
  IrcVariable *var;
  int count = 0;
...
void savebitchx_variables(FILE *fp) {
  /* Save all VF_BITCHX variables. */
  int count = save_vars_by_flags(fp, 0, 0, VF_BITCHX | VF_NO_SAVE, VF_BITCHX);
...
char *make_string_var(const char *var_name) {
  ...
  if ((find_fixed_array_item(irc_variable, sizeof(IrcVariable),
                             NUMBER_OF_VARIABLES, copy, &cnt,
                             &msv_index) == NULL))
    return NULL;
  if (cnt >= 0)
    return NULL;
...
/* exec_warning: a warning message displayed whenever EXEC_PROTECTION is turned
 * off.  */
static void exec_warning(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value) {
  if (value == OFF) {
...
static void eight_bit_characters(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value) {
  if (value == ON && !term_eight_bit())
    say("Warning!  Your terminal says it does not support eight bit "
        "characters");
  set_term_eight_bit(value);
}

static void set_realname(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  if (value)
...
void reinit_autoresponse(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
...
static void set_numeric_string(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  malloc_strcpy(&thing_ansi, value);
}

static void set_user_mode(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
...
#ifdef WANT_OPERVIEW
static void set_ov_mode(Window *win __attribute__((unused)), char *value __attribute__((unused)), int unused) {
...
static void set_away_time(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value) {
  if (value == 0)
...
static void reinit_screen(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value __attribute__((unused))) {
...
void reinit_status(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value __attribute__((unused))) {
  update_all_windows();
  update_all_status(current_window, NULL, 0);
}
...
void toggle_reverse_status(Window *win, char *unused, int value) {
  ...
  set_string_var(SHOW_NUMERICS_STR_VAR,
                 value ? DEFAULT_SHOW_NUMERICS_STR : NO_NUMERICS_STR);
  set_numeric_string(current_window,
                     value ? DEFAULT_SHOW_NUMERICS_STR : NO_NUMERICS_STR, 0);
  reinit_status(win, unused, value);
}

#ifdef WANT_TCL
static char *ircii_rem_str(ClientData cd, Tcl_Interp *intp, char *name1,
...
void add_tcl_vars(void) {
  ...
  for (i = 0; irc_variable[i].name; i++) {
    ...
    if (irc_variable[i].type == STR_TYPE_VAR)
      Tcl_TraceVar(tcl_interp, varname, TCL_TRACE_WRITES, &ircii_rem_str,
...
static void set_clock_format(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
...
static void set_dcc_timeout(Window *win __attribute__((unused)), char *unused __attribute__((unused)), int value) {
...
static void set_use_socks(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
...
static void set_cmdchars(Window *win __attribute__((unused)), char *value, int unused __attribute__((unused))) {
...
static void set_mangle_inbound(Window *w __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  char *nv = NULL;
...
static void set_mangle_outbound(Window *w __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  char *nv = NULL;
...
static void set_mangle_logfiles(Window *w, char *value, int unused __attribute__((unused))) {
  char *nv = NULL;
...
static void set_mangle_operlog(Window *w __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  char *nv = NULL;
...
static void set_nat_address(Window *w __attribute__((unused)), char *value, int unused __attribute__((unused))) {
  char *nv = NULL, *h;
  if (value && *value) {
...
#ifdef GUI
IrcVariable *return_irc_var(int nummer) { return &irc_variable[nummer]; }
#endif
